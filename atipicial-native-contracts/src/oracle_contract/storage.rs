...
use atipicial_payloads::{OracleResponse, Transaction, TransactionAttribute};
...
impl OracleContract {
    ...
    pub fn get_request<B: atipicial_storage::CacheRead>(
        &self,
    ...
    pub fn get_requests<B: atipicial_storage::CacheRead>(
        &self,
        snapshot: &DataCache<B>,
    ...
    pub fn get_requests_by_url<B: atipicial_storage::CacheRead>(
        &self,
        snapshot: &DataCache<B>,
        url: &str,
    ...
    pub(in crate::oracle_contract) fn put_price<B: atipicial_storage::CacheRead>(
        &self,
        snapshot: &DataCache<B>,
        price: i64,
    ) -> CoreResult<()> {
    ...
    pub(in crate::oracle_contract) fn read_price<B: atipicial_storage::CacheRead>(
        &self,
        snapshot: &DataCache<B>,
    ) -> CoreResult<i64> {
    ...
    pub(in crate::oracle_contract) fn read_request_id<B: atipicial_storage::CacheRead>(
        &self,
        snapshot: &DataCache<B>,
    ) -> CoreResult<u64> {
    ...
    pub(in crate::oracle_contract) fn write_request_id<B: atipicial_storage::CacheRead>(
        &self,
        snapshot: &DataCache<B>,
        value: &BigInt,
    ) {
    ...
    pub(in crate::oracle_contract) fn read_request<B: atipicial_storage::CacheRead>(
        &self,
        snapshot: &DataCache<B>,
        id: u64,
    ) -> CoreResult<Option<OracleRequest>> {
    ...
    pub(in crate::oracle_contract) fn add_request_record<B: atipicial_storage::CacheRead>(
        &self,
        snapshot: &DataCache<B>,
        id: u64,
        request: &OracleRequest,
