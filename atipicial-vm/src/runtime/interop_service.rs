//! Interop service registry aligned with Atipicial's C# implementation.
//!
...
/// `Atipicial.SmartContract.InteropDescriptor` while keeping Rust ergonomics.
#[derive(Clone)]
pub struct VmInteropDescriptor<S = ()> {
    ...
    ///
    /// In the Atipicial N3 reference implementation, the host (`ApplicationEngine`) applies
