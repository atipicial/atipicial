...
use atipicial_payloads::{Block, Header, Transaction, TransactionState};
...
impl crate::service_context::SystemContext for ColdReadContext {
    ...
    fn ledger_provider<'a>(
        &'a self,
        snapshot: &'a atipicial_storage::DataCache,
...
async fn command_loop_uses_system_context_cold_provider_after_hot_cache_eviction() {
    ...
    let system = Arc::new(ColdReadContext {
        chain_spec: atipicial_test_fixtures::test_chain_spec(atipicial_config::ProtocolSettings::default()),
