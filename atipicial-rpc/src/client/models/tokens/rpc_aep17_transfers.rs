...
/// AEP17 transfers for an address matching C# `RpcAep17Transfers`
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct RpcAep17Transfers {
    /// User script hash
    pub user_script_hash: UInt160,

    /// List of sent transfers
    pub sent: Vec<RpcAep17Transfer>,

    /// List of received transfers
    pub received: Vec<RpcAep17Transfer>,
}

impl RpcAep17Transfers {
    /// Converts to JSON
    /// Matches C# `ToJson`
    #[must_use]
    ...
    pub fn from_json(json: &JObject, protocol_settings: &ProtocolSettings) -> CoreResult<Self> {
        let (sent, received, user_script_hash) =
            parse_transfer_lists(json, protocol_settings, RpcAep17Transfer::from_json)?;
...
/// Individual AEP17 transfer entry matching C# `RpcAep17Transfer`
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct RpcAep17Transfer {
...
#[cfg(test)]
#[path = "../../../tests/client/models/tokens/rpc_aep17_transfers.rs"]
mod tests;
