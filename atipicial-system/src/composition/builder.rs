//! Final assembly of an already-composed Atipicial node.
//!
...
use atipicial_blockchain::{BlockchainHandle, HeaderCache, OptionalStaticLedgerProvider};
...
use atipicial_runtime::{SharedStoreSyncStageCheckpointStore, SharedStoreVerifiedHeaderStore};
...
pub struct NodeBuilder<P = atipicial_native_contracts::StandardNativeProvider, S = MemoryStore>
where
    ...
    S: TransactionalStore + 'static,
{
    ...
    pub fn build(self) -> Node<P, S> {
        ...
        Node {
            ...
            ledger_provider_factory: atipicial_blockchain::HotColdLedgerProviderFactory::new(
