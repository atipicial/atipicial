//! Stack operations for the Atipicial Virtual Machine.
//!
//! This module provides the stack operation handlers for the Atipicial VM.
...
// TOALTSTACK and FROMALTSTACK removed - not in C# Atipicial
