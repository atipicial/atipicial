...
//! `Atipicial.Network.P2P.Message` round-trip.
...
/// Strongly-typed representation of every payload carried by the Atipicial P2P protocol.
...
#[cfg(test)]
#[path = "../tests/wire/protocol_message.rs"]
mod tests;
