...
//!
//! This module belongs to `atipicial-system`: it wires already-defined runtime
...
///
/// `atipicial-runtime` owns the reusable queue, commit policy, and checkpoint driver.
...
/// handle without reaching into `atipicial-blockchain` command internals.
#[derive(Clone)]
    ...
    C: SyncStageCheckpointStore,
{
    ...
    pub fn driver(
        &self,
    ) -> atipicial_runtime::ServiceResult<SyncPipelineDriver<BlockImportQueue<BlockchainHandle>, C>> {
