...
Guidance for observing a `atipicial-cli` deployment.
...
- Logs: ship `/data/Logs/atipicial-cli.log` (or your configured log path) to your log stack with alerts on errors/timeouts/restarts.
