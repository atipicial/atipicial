...
//! daemon context in `atipicial-node` exposes the canonical store snapshot and commit
...
use atipicial_payloads::{ApplicationExecuted, Block};
...
pub trait SystemContext:
    ChainSpecProvider<ChainSpec = AtipicialChainSpec> + Send + Sync + std::fmt::Debug
{
    ...
    type CacheBacking: atipicial_storage::CacheRead;
    ...
    fn store_snapshot(&self) -> Option<Arc<atipicial_storage::DataCache<Self::CacheBacking>>> {
        None
    }
    ...
    fn ledger_provider<'a>(
        &'a self,
        snapshot: &'a atipicial_storage::DataCache<Self::CacheBacking>,
    ...
    fn block_committing(
        &self,
        _block: &Block,
        _snapshot: &atipicial_storage::DataCache<Self::CacheBacking>,
    ...
    fn block_committing_with_context(
        &self,
        block: &Block,
        snapshot: &atipicial_storage::DataCache<Self::CacheBacking>,
