...
pub(super) struct ReadinessSnapshot {
    ...
    pub(super) ledger_source: &'static str,
    pub(super) remote_ledger_rpc: Option<String>,
    pub(super) remote_ledger_error: Option<String>,
...
pub(super) fn readiness_response(snapshot: ReadinessSnapshot) -> Response<Body> {
    json_response(
        ...
        json!({
            ...
            "service": "atipicial-node",
            "version": env!("CARGO_PKG_VERSION"),
            "network": snapshot.network_label,
            "ledger_source": snapshot.ledger_source,
            "remote_ledger_rpc": snapshot.remote_ledger_rpc,
            "remote_ledger_error": snapshot.remote_ledger_error,
...
pub(super) fn indexer_readiness(
    ...
    status: Option<Result<atipicial_indexer::IndexerStatus, String>>,
) -> ServiceReadiness {
    match status {
