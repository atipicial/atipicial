//! # atipicial-primitives::protocol
//!
//! Protocol enums, versioned records, and chain-level domain constants.
//!
//! ## Boundary
//!
//! This module belongs to `atipicial-primitives`. This foundation crate must stay
...
/// Log-level primitives used by Atipicial diagnostics and extension utilities.
