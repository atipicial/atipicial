//! Pointer stack item implementation for the Atipicial Virtual Machine.
//!
//! Mirrors `Atipicial.VM.Types.Pointer` by tracking both the script reference and
...
impl Pointer {
    ...
    /// Pointers are always truthy in Atipicial VM.
    #[must_use]
