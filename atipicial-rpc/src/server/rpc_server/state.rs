...
impl RpcServer {
    ...
    pub fn set_oracle_service(
        &mut self,
        service: Arc<atipicial_oracle_service::OracleService<NodeContext>>,
    ) {
    ...
    #[must_use]
    pub fn oracle_service(&self) -> Option<Arc<atipicial_oracle_service::OracleService<NodeContext>>> {
