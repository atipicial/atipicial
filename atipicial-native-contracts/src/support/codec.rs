...
//! ## Boundary
//!
//! This module belongs to `atipicial-native-contracts`. It wraps `atipicial_serialization`
//! and `atipicial_vm` primitives that every native contract codec already uses;
...
/// (`DepositState`, `AtipicialAccountStateView`, `CandidateState`, `CachedCommittee`,
