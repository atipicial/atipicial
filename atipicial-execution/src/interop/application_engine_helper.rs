//! ApplicationEngine.Helper - matches C# Atipicial.SmartContract.ApplicationEngine helper methods exactly
...
use atipicial_vm::VmOrderedDictionary;
use atipicial_vm::VmState as VMState;
use atipicial_vm::stack_item::{Array as ArrayItem, Map as MapItem, Struct as StructItem};
    ...
    B: atipicial_storage::CacheRead,
{
    ...
    pub fn emit_log_event(&mut self, event: atipicial_payloads::LogEventArgs) {
        self.push_log(event);
    }
