//! Atipicial v3.10.1 `Atipicial.Wallets.Helper.CalculateNetworkFee` parity path.
...
use atipicial_payloads::{HEADER_SIZE, VerifiableContainer};
use atipicial_primitives::CallFlags;
use atipicial_primitives::{ContractParameterType, TriggerType, UInt160};
...
fn dummy_verify_invocation_script(
    parameters: &[atipicial_manifest::ContractParameterDefinition],
) -> Vec<u8> {
...
fn run_contract_verify<P, B>(
    ...
    verify_method: atipicial_manifest::ContractMethodDescriptor,
