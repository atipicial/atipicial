//! # atipicial-config
//!
//! Immutable chain specifications and protocol configuration for Atipicial N3 nodes.
//!
//! ## Boundary
//!
...
pub use network::chain_spec::{ChainIdentity, ChainSpecError, ChainSpecProvider, AtipicialChainSpec};
