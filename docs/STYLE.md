...
# Atipicial-rs Code Style Guide

> **Version**: 1.0.0  
> **Last Updated**: 2026-07-02

This document defines the coding standards and conventions for the atipicial-rs project.
...
#![doc(html_root_url = "https://docs.rs/atipicial-crate-name/0.11.1")]
...
|------|------------|---------|
| Crates | `kebab-case` | `atipicial-runtime`, `atipicial-primitives` |
...
| Constants | `SCREAMING_SNAKE_CASE` | `MAX_BLOCK_SIZE`, `ATC_DECIMALS` |
...
refactor(storage): extract storage traits to atipicial-storage crate
