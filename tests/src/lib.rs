...
pub mod state {
    ...
    pub struct AccountState {
        account: UInt160,
        atipicial_balance: u64,
        gas_balance: u64,
    }

    impl AccountState {
        /// Create an account state with explicit ATC and ATD balances.
        pub fn with_balances(account: UInt160, atipicial_balance: u64, gas_balance: u64) -> Self {
            Self {
                account,
                atipicial_balance,
                gas_balance,
        ...
        /// Return the ATC balance.
        pub fn atipicial_balance(&self) -> u64 {
            self.atipicial_balance
        }

        /// Return the ATD balance.
            ...
            for (account, value) in &changes.accounts {
                ...
                match value {
                    Some(state) => {
                        ...
                        bytes.extend_from_slice(&state.atipicial_balance.to_le_bytes());
