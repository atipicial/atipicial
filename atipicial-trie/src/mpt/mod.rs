//! # Atipicial MPT Implementation
//!
//! ## Boundary
//!
//! This module owns the internal Atipicial-compatible node graph, mutation cache,
...
/// Prefix of every content-addressed MPT node key in Atipicial state storage.
