...
fn de(json: &str) -> atipicial_error::CoreResult<StackItem> {
...
#[test]
fn deserialize_enforces_atipicialvm_map_key_size() {
...
fn deserialize_large_integer_rounds_through_double_like_csharp() {
    // C# JsonSerializer.Deserialize reads every JNumber as a `double` (Atipicial.Json
