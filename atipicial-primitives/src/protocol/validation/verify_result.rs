//! `VerifyResult` - matches C# Atipicial.Ledger.VerifyResult exactly.
//!
//! This is the single source of truth for `VerifyResult` enum. Both `atipicial-core::ledger`
//! and atipicial-p2p re-export this type for backward compatibility.
...
#[cfg(test)]
#[path = "../../tests/protocol/validation/verify_result.rs"]
mod tests;
