...
pub static RPC_REQ_TOTAL: RpcCounter =
    RpcCounter::new("atipicial_rpc_requests_total", "Total RPC requests");

/// Total number of RPC requests that returned an RPC error.
pub static RPC_ERR_TOTAL: RpcCounter = RpcCounter::new("atipicial_rpc_errors_total", "Total RPC errors");
