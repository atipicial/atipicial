...
static class Oracle
{
    ...
    private static Dictionary<string, object?> StackValue(StackItem item) => new()
    {
        ...
        ["value"] = item switch
        {
            Atipicial.VM.Types.Integer value => value.GetInteger().ToString(),
            Atipicial.VM.Types.Boolean value => value.GetBoolean(),
            Null => null,
            _ => item.ToString(),
        },
    };
    ...
    public static void Main()
    {
        ...
        {
            validAbort.EmitPush("ATC").Emit(OpCode.ABORTMSG);
        ...
        var output = new Dictionary<string, object?>
        {
            ...
            {
                ["repository"] = "https://github.com/atipicial-project/atipicial-vm.git",
