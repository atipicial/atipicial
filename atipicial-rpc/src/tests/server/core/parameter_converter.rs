...
use atipicial_execution::contract_parameter::ContractParameter;
use atipicial_payloads::transaction::MAX_TRANSACTION_ATTRIBUTES;
use atipicial_primitives::ContractParameterType;
use atipicial_primitives::{UInt160, UInt256};
use atipicial_serialization::json::{JArray, JObject, JToken, MAX_SAFE_INTEGER};
use uuid::Uuid;
...
fn address_conversion_accepts_base58() {
    ...
    let base58 = atipicial_wallets::wallet_helper::WalletAddress::to_address(&UInt160::zero(), version);
