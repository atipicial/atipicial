...
fn sample_protocol() -> RpcProtocol {
    ...
    hardforks.insert("atipicial3".to_string(), 0);
    ...
    RpcProtocol {
        ...
        initial_gas_distribution: 50_000_000_000_000_000,
        hardforks,
...
fn rpc_version_roundtrip() {
    ...
    assert_eq!(
        parsed.protocol.hardforks.get("atipicial3"),
        version.protocol.hardforks.get("atipicial3")
    );
