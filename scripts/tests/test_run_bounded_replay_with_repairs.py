...
class RunBoundedReplayWithRepairsTests(unittest.TestCase):
    ...
    def test_timeout_without_new_repairable_failure_continues(self):
        ...
        self.assertIn("no AtipicialDollar", summary["attempts"][0]["repair_error"])
    ...
    def test_cli_passes_db_height_reader_to_bounded_runner(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            try:
                ...
                sys.argv = [
                    ...
                    "700000",
                    "--probe-bin",
                    "target/release/atipicial-db-probe",
                    "--node-output-log",
                    str(node_output_log),
                ]
        ...
        self.assertEqual(
            captured["probe_args"],
            (Path("bounded/data"), Path("target/release/atipicial-db-probe")),
        )
    ...
    def test_cli_uses_mdbx_probe_and_repair_without_backend_selector(self):
        ...
        def fake_load_script_module(_filename, module_name):
            ...
            return SimpleNamespace(
                read_log_text=lambda _path, _offset: (
                    "native AtipicialDollar TriggerType(ON_PERSIST) hook failed at block 151117: "
                    "Invalid operation: AtipicialDollar::burn: insufficient balance 55342295 to burn 91584640\n"
                ),
