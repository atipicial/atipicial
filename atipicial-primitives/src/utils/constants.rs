//! Protocol constants for Atipicial blockchain.
//!
//! These constants define fundamental sizes and limits used throughout the protocol.
//! Matches C# Atipicial constants exactly.
...
/// Seconds per block (default for Atipicial N3).
...
/// Genesis block timestamp in milliseconds: **2026-07-20 00:00:00 UTC**
/// (the Atipicial Chain genesis date; matches `atipicial_config::GENESIS_TIMESTAMP_MS`).
pub const GENESIS_TIMESTAMP_MS: u64 = 1_784_505_600_000;

// === Address Constants ===

/// Atipicial N3 address version byte.
pub const ADDRESS_VERSION: u8 = 0x09;
...
/// Total initial ATD distribution (datoshi, 1e8 per unit):
/// 500,000,000 ATD genesis supply.
pub const INITIAL_GAS_DISTRIBUTION: u64 = 500_000_000 * 100_000_000;
