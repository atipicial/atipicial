...
#[test]
fn csharp_default_matches_atipicial_v3101_protocol_settings_default() {
...
#[test]
fn load_mainnet_json_matches_atipicial_node_v3101_protocol_configuration() {
    let json = br#"{
        "ProtocolConfiguration": {
            "Network": 860833102,
            "AddressVersion": 53,
...
#[test]
fn load_testnet_json_matches_atipicial_node_v3101_protocol_configuration() {
    let json = br#"{
        "ProtocolConfiguration": {
            "Network": 894710606,
            "AddressVersion": 53,
            ...
            "SeedList": [
                ...
                "seed4t5.atipicial.com:20333",
                "seed5t5.atipicial.com:20333"
            ]
        }
    }"#;
    let mut stream = &json[..];
...
#[test]
fn mainnet_preset_matches_atipicial_n3_v3101_protocol_limits() {
...
#[test]
fn testnet_preset_matches_atipicial_n3_v3101_protocol_limits() {
