...
/// Atipicial protocol release whose execution semantics produced a plan.
#[derive(Clone, Copy, Debug, Eq, Hash, PartialEq)]
...
impl ProtocolVersion {
    /// Atipicial N3 v3.10.1, the current compatibility target.
    pub const ATC_N3_V3_10_1: Self = Self::new(3, 10, 1);
...
impl ProtocolIdentity {
    ...
    /// Returns the Atipicial network magic.
    #[must_use]
...
impl ContractResolutionIdentity {
    ...
    /// Returns the checksum of the resolved AEF.
    #[must_use]
    pub const fn aef_checksum(self) -> u32 {
        self.aef_checksum
    }
}
...
impl ExecutionPlanKey {
    ...
    /// Returns Atipicial's protocol Hash160 for the retained bytecode.
    #[must_use]
