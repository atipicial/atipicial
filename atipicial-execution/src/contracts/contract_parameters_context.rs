//! ContractParametersContext - matches C# Atipicial.SmartContract.ContractParametersContext exactly
...
use atipicial_payloads::{transaction::Transaction, witness::Witness};
...
impl ContractParametersContext {
    ...
    pub fn new_with_type(
        ...
        let verifiable_type =
            verifiable_type.unwrap_or_else(|| "Atipicial.Network.P2P.Payloads.Verifiable".to_string());
    ...
    pub fn from_transaction_json(json: &serde_json::Value) -> CoreResult<(Self, Transaction)> {
        ...
        if type_name != "Atipicial.Network.P2P.Payloads.Transaction" {
