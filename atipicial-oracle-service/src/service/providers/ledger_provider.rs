...
use atipicial_payloads::TransactionState;
...
pub(in crate::service) trait OracleLedgerProvider {
...
pub(in crate::service) struct NativeOracleLedgerProvider {
...
impl NativeOracleLedgerProvider {
    ...
    #[must_use]
    pub(in crate::service) const fn new() -> Self {
        Self {
            ledger: LedgerContract,
        }
    }
