//! Atipicial network type (MainNet / TestNet / Private).
...
#[error("unsupported Atipicial network type {value:?}")]
pub struct NetworkTypeParseError {
    value: String,
}

/// Atipicial network type
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash, Serialize, Deserialize)]
#[serde(rename_all = "lowercase")]
pub enum NetworkType {
    /// Atipicial `MainNet` (network magic: 860833102)
    MainNet,
    /// Atipicial `TestNet` T5 (network magic: 894710606)
    TestNet,
