//! `TransactionAttributeType` - matches C# Atipicial.Network.P2P.Payloads.TransactionAttributeType exactly.
...
#[cfg(test)]
#[path = "../../tests/protocol/ledger/transaction_attribute_type.rs"]
mod tests;
