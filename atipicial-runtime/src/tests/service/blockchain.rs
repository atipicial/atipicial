...
fn relay_result_event_is_field_wise() {
    let event = BlockchainEvent::RelayResult {
        ...
        inventory_type: atipicial_payloads::InventoryType::Transaction,
        block_index: Some(11),
        result: atipicial_primitives::VerifyResult::Invalid,
    };
    ...
    assert_ne!(
        ...
        BlockchainEvent::RelayResult {
            hash: UInt256::from([7u8; 32]),
            inventory_type: atipicial_payloads::InventoryType::Extensible,
            block_index: Some(11),
            result: atipicial_primitives::VerifyResult::Invalid,
        }
    );
