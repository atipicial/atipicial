    ...
    B: atipicial_storage::CacheRead,
{
    ...
    vec![
        ...
        // Faun path emits ATC's Vote notification via VoteInternal). Exactly one
        ...
        // committee sweep of a long-blocked account's AEP-17 funds to Treasury.
        NativeMethodBinding::new(
            NativeMethod::new(
                "recoverFund",
                1 << 15,
                ...
                // the AllowCall bit gates the nested AEP-17 balanceOf/transfer
