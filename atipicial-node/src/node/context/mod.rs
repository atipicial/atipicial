//! # atipicial-node::node::context
//!
//! Application-owned durability hooks and finalized projections.
//!
//! ## Boundary
//!
//! This module belongs to `atipicial-node`. This application crate may compose lower
    ...
    P: NativeContractProvider,
{
    ...
    finalized_blocks:
        atipicial_system::FinalizedBlockHandle<atipicial_storage::persistence::StoreCacheBacking<RuntimeStore>>,
    static_archive: Option<atipicial_blockchain::StaticLedgerArchive>,
    pending_static_records: Mutex<Vec<atipicial_static_files::StaticRecord>>,
    ...
    T: Store + 'static,
{
    pub(super) fn compose(
        ...
        tokens_tracker: Option<Arc<atipicial_rpc::plugins::tokens_tracker::TokensTracker<P, T>>>,
        static_archive: Option<atipicial_blockchain::StaticLedgerArchive>,
        replay_guard: Arc<LocalReplayGuard>,
        append_shadow: Option<Arc<crate::node::append_shadow::AppendShadow>>,
        authoritative_pack: Option<Arc<crate::node::state_packs::AuthoritativeNodePack>>,
        ...
        let (finalized_blocks, finalized_stream) =
            atipicial_system::FinalizedBlockStreamFactory::default()
                .for_backing::<atipicial_storage::persistence::StoreCacheBacking<RuntimeStore>>()
