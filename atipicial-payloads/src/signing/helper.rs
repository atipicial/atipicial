//! Helper utilities matching `Atipicial.Network.P2P.Helper`.
//!
...
/// mirroring `Atipicial.Network.P2P.Helper`.
pub fn get_sign_data<V>(
    verifiable: &V,
    network: u32,
) -> atipicial_error::CoreResult<[u8; SIGN_DATA_LENGTH]>
where
    V: atipicial_primitives::Verifiable + ?Sized,
{
    let hash = verifiable
        .hash()
...
pub fn get_sign_data_vec<V>(verifiable: &V, network: u32) -> atipicial_error::CoreResult<Vec<u8>>
where
    V: atipicial_primitives::Verifiable + ?Sized,
{
