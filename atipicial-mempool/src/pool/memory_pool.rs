//! [`MemoryPool`] - the Atipicial transaction memory pool.
//!
...
use atipicial_primitives::{TransactionRemovalReason, UInt160, UInt256, VerifyResult};
...
/// Atipicial transaction memory pool.
pub struct MemoryPool<P = atipicial_native_contracts::StandardNativeProvider>
where
    ...
    pub fn reverify_top_unverified<B: CacheRead>(
        ...
        let more_unverified = {
            ...
            for item in to_check {
                ...
                // persist. atipicial-rs performs network announcement outside the
