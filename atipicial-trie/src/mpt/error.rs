//! Typed failures produced by Atipicial MPT parsing, mutation, and storage adapters.

use atipicial_io::IoError;
...
atipicial_error::impl_error_from_struct!(atipicial_error::CoreError, MptError => Cryptographic);
