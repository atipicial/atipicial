...
use atipicial_mempool::PoolItem;
use atipicial_payloads::{Header, TransactionState, block::Block, transaction::Transaction};
use atipicial_primitives::{UInt256, hex_util};
...
fn header_fields_to_map(
    ...
    // Canonical header wire-JSON is owned by `atipicial_payloads::Header::to_json`
