//! # atipicial-node::node::indexer_runtime::stage
//!
...
use atipicial_indexer::{IndexBlockBatchEntry, IndexerService, IndexerStatus, NotificationIndexRecord};
use atipicial_payloads::Block;
use atipicial_primitives::UInt256;
use atipicial_runtime::{ServiceError, ServiceResult, SyncStageKind};
...
impl CanonicalIndexSource for atipicial_blockchain::BlockchainHandle {
    fn chain_height(&self) -> impl Future<Output = ServiceResult<u32>> + Send {
...
pub(crate) enum IndexStageError {
    ...
    Reconcile {
        height: u32,
        #[source]
        source: atipicial_indexer::IndexerError,
    },
