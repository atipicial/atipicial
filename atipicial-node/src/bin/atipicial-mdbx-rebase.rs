...
use atipicial_state_service::{MDBX_STATE_SERVICE_NAMESPACE, MPT_NODE_KEY_BYTES, MPT_NODE_PREFIX};
...
const MAINTENANCE_TABLE: &str = "atipicial_node_metadata";

#[derive(Debug, Parser)]
#[command(
    name = "atipicial-mdbx-rebase",
    about = "Copy Atipicial MDBX while removing pack-authoritative legacy MPT rows"
)]
struct Cli {
