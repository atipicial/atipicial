//! `MethodToken` — AEF static-call descriptor (matches C#
//! `Atipicial.SmartContract.MethodToken`).
//!
//! ## Layering
//!
//! Pure data type in **Layer 1 (protocol)**. Depends only on
//! `atipicial-primitives` (for `UInt160`, `CallFlags`) and the serde
...
#[cfg(test)]
#[path = "../tests/aef/method_token.rs"]
mod tests;
