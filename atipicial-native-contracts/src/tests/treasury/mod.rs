//! # atipicial-native-contracts::tests::treasury
//!
...
fn native_contract_surface() {
    ...
    assert_eq!(names, ["onAEP17Payment", "onAEP11Payment", "verify"]);
...
/// Faun and its manifest declares AEP-26/AEP-27/AEP-30 unconditionally.
#[test]
fn faun_activation_and_manifest_standards() {
    ...
    // Atipicial N3 v3.10.1 MainNet schedules Faun at 8,800,000, so default
