//! # atipicial-rpc::server::rpc_method_attribute
//!
//! RPC method descriptors and metadata.
//!
//! ## Boundary
//!
...
//! ## Contents
//!
//! - `rpc_method_attribute`: RPC method descriptor records and metadata.

// Rust equivalent of `Atipicial.Plugins.RpcServer.RpcMethodAttribute`. The original
...
pub struct RpcMethodDescriptor {
    ...
    /// matching Atipicial C# behavior. This flag is kept for metadata only.
    #[serde(default)]
