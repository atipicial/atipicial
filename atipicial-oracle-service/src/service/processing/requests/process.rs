...
use atipicial_payloads::{OracleResponse, OracleResponseCode};
use atipicial_storage::persistence::DataCache;
use atipicial_wallets::{Wallet, WalletAccount};
...
{
    pub(in super::super::super) async fn process_request<B: atipicial_storage::CacheRead>(
        &self,
        ...
        debug!(target: "atipicial::oracle", request_id, "oracle request processed");
        Ok(())
    }
}
