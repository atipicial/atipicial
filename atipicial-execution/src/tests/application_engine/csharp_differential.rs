...
const ATC_COMMIT: &str = "d10e9ceecdabe3fcff719ee68ea5b76ba7e62c3d";
...
fn hardfork_settings(entries: &[(Hardfork, u32)]) -> ProtocolSettings {
    ...
    settings.hardforks =
        atipicial_config::HardforkSchedule::new().with_activations(entries.iter().copied());
    settings
}
...
fn csharp_v3101_application_fixture_has_pinned_complete_coverage() {
    ...
    assert_eq!(fixture["oracle"]["commit"], ATC_COMMIT);
