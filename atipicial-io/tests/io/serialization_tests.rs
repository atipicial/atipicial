...
//!
//! These tests ensure full compatibility with C# Atipicial's ISerializable functionality.
//! Tests are based on the C# Atipicial.IO.ISerializable test suite.
...
mod tests {
    ...
    fn test_serialization_round_trip_compatibility() {
        let original = TestSerializable {
            value1: 12345,
            value2: "Hello Atipicial".to_string(),
            value3: true,
    ...
    #[test]
    fn test_exact_array_deserialization_rejects_mismatched_count_before_items() {
        let items = vec![
            TestSerializable {
                value1: 1,
                value2: "First".to_string(),
