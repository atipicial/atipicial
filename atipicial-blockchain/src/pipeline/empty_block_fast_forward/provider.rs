...
//!
//! The fast-forward stage belongs to `atipicial-blockchain`, but the state transition
//! math belongs to `atipicial-native-contracts`. This provider seam keeps staging
