...
//!
//! A [`WalletProvider`] wraps the optional AEP-6 wallet used by node services.
...
pub struct WalletProvider {
    ...
    inner: Arc<RwLock<Option<Arc<Aep6Wallet>>>>,
}
...
impl WalletProvider {
    ...
    /// already loaded.
    pub fn with_wallet(wallet: Arc<Aep6Wallet>) -> Self {
        Self {
    ...
    pub async fn read(&self) -> tokio::sync::RwLockReadGuard<'_, Option<Arc<Aep6Wallet>>> {
    ...
    pub async fn install(&self, wallet: Arc<Aep6Wallet>) {
    ...
    fn peek(&self) -> Option<Arc<Aep6Wallet>> {
