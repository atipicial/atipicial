...
pub struct ProtocolIdentityV1 {
    ...
    /// Canonical atipicial-vm implementation/image digest.
    pub atipicial_vm: Digest32,
    /// Canonical Atipicial MPT codec digest.
...
pub struct CheckpointCertificateV1 {
    ...
    /// Canonical Atipicial multisignature witness bytes.
...
pub enum ObjectLocatorV1 {
    /// AtipicialFs container and object IDs, encoded as bounded ASCII bytes.
    AtipicialFs {
        /// AtipicialFs container ID.
        container_id: BoundedBytes,
        /// AtipicialFs object ID.
...
pub struct MptPointProofV1 {
    ...
    /// Canonical Atipicial MPT proof-node bytes.
