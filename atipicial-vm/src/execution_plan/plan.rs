//! Strictly verified, bounded, immutable AtipicialVM execution plans.
...
pub enum ExecutionPlanRoute {
    ...
    Planned,
    /// Ordinary `atipicial-vm` was loaded before any planned effect became visible.
    OrdinaryFallback,
}
...
impl ExecutionPlanLimits {
    ...
    /// continue through ordinary `atipicial-vm` without a plan.
...
pub enum ExecutionPlanBuildError {
    ...
    /// Strict AtipicialVM parsing or validation rejected the script.
...
pub enum PlannedControlFlow {
    ...
    Syscall {
        /// Atipicial interop service identifier.
        service: u32,
    },
...
impl PlannedInstruction {
    /// Returns the ordinary AtipicialVM instruction consumed by consensus handlers.
    #[must_use]
