...
pub(crate) enum TransactionValidationOutcome {
    ...
    Rejected {
        ...
        /// Submission origin.
        origin: TransactionOrigin,
        /// Canonical Atipicial verification verdict.
        result: VerifyResult,
    },
}
...
pub enum TransactionAdmissionOutcome {
    ...
    /// Transaction was deterministically rejected by Atipicial admission policy.
    Rejected {
...
impl TransactionAdmissionOutcome {
    ...
    /// Returns the canonical verdict exposed by existing Atipicial wire/RPC surfaces.
    #[must_use]
