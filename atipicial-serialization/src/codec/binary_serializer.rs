...
//! BinarySerializer - aligns with `Atipicial.SmartContract.BinarySerializer`.

use atipicial_error::{CoreError, CoreResult};
use atipicial_io::var_int::VarInt;
use atipicial_io::{IoError, MemoryReader};
                ...
                PendingItem::Container(container) => {
                    let result = match container.item_type {
                        ...
                        StackItemType::Map => {
                            ...
                            let map = atipicial_vm::stack_item::Map::new(
                                atipicial_vm::VmOrderedDictionary::new(),
                                None,
                            )
