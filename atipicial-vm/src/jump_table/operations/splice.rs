//! Splice operations for the Atipicial Virtual Machine.
//!
//! This module provides the splice operation handlers for the Atipicial VM.
...
mod tests {
    ...
    #[test]
    fn local_span_matches_atipicialvm_primitive_memory() {
        assert_eq!(
