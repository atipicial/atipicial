//! # atipicial-execution::host_access_audit
//!
...
use atipicial_primitives::{FindOptions, Hardfork, UInt160};
use atipicial_storage::StorageKey;
use atipicial_vm::{ContractResolutionIdentity, NativeCacheDomain, RangeDirection};
use std::mem::size_of;
use std::sync::Arc;
...
impl StorageRangeAccess {
    ...
    /// Exact Atipicial `FindOptions`, including direction.
    #[must_use]
