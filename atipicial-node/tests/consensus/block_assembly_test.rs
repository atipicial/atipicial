...
use atipicial_consensus::BlockData;
use atipicial_crypto::{ECCurve, ecc::EcdsaVerify};
...
async fn test_complete_block_assembly_workflow() {
    ...
    let block_data = BlockData {
        block_index: 12345,
        version: 0,
        prev_hash: atipicial_primitives::UInt256::zero(),
        ...
        next_consensus: atipicial_primitives::UInt160::zero(),
    };
