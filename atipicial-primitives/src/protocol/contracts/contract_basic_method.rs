//! ContractBasicMethod - matches C# Atipicial.SmartContract.ContractBasicMethod exactly

/// This class provides a guideline for basic methods used in the Atipicial blockchain, offering
...
impl ContractBasicMethod {
    ...
    /// The update method. Requires AefFile or Manifest, or both, and is passed to _deploy.
    /// Should verify the signer's address using SYSCALL Atipicial.Runtime.CheckWitness.
