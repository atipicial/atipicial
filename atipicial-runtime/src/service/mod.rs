...
//! ## Boundary
//!
//! This module belongs to `atipicial-runtime`. This runtime API crate owns shared
...
//! - `aep17`: Shared AEP-17 metadata capability contract.
...
pub use aep17::{Aep17Metadata, Aep17MetadataReader};
