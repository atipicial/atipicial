//! # atipicial-vm::execution_engine
//!
//! AtipicialVM execution engine loop and runtime state.
//!
//! ## Boundary
//!
//! This module belongs to `atipicial-vm`. This VM crate owns deterministic script
...
//! - `interop`: Interop host glue between AtipicialVM execution and native/runtime
//!   services.
...
/// Value is in fractional ATD units where 1 ATD = 100_000_000 (10^8)
pub const DEFAULT_GAS_LIMIT: u64 = 20_0000_0000; // 20 ATD

use crate::{ExecutionEngineLimits, VmState as VMState};

/// The execution engine for the Atipicial VM.
