...
/// Broad AtipicialVM opcode families used to identify execution workload shape.
...
/// Bounded profile for one immutable AtipicialVM bytecode script.
///
/// `script_hash` is Atipicial's protocol `Hash160` of the bytecode. It is an
...
impl ScriptExecutionProfile {
    /// Atipicial protocol `Hash160` of the immutable bytecode.
    #[must_use]
