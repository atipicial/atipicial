...
//! reward calculation, and ATD minting out of the contract root.
...
impl Notary {
    ...
    /// the NotaryAssisted share `AtipicialDollar::on_persist` withholds from the
    /// primary-validator network-fee mint, so per-block ATD supply is
    ...
    >(
        ...
        for notary in notaries {
            ...
            crate::AtipicialDollar::new().gas_mint(engine, &address, &single_reward, false)?;
        }
        Ok(())
    }
}
