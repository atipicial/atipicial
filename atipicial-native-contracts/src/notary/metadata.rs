    ...
    B: atipicial_storage::CacheRead,
{
    ...
    vec![
        ...
        // onAEP17Payment(from, amount, data) -> Void: ATD deposit callback, States.
        NativeMethodBinding::new(
            crate::aep17_payment_method(1 << 15, false, CallFlags::STATES.bits()),
...
pub(super) static NOTARY_METHODS: LazyLock<Vec<NativeMethod>> = LazyLock::new(|| {
    method_metadata(&notary_method_bindings::<
