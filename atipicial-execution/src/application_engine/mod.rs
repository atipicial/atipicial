//! # atipicial-execution::application_engine
//!
//! ApplicationEngine interop groups and execution-facing syscall handlers.
//!
//! ## Boundary
//!
//! This module belongs to `atipicial-execution`. This execution crate owns VM/native
...
//! - `witness_and_misc`: witness and miscellaatipicialus syscall handlers.
...
use atipicial_config::hardfork::Hardfork;
use atipicial_crypto::{Crypto, ECCurve, ECPoint};
use atipicial_error::{CoreError, CoreResult};
use atipicial_payloads::Block;
use atipicial_primitives::constants::HASH_SIZE;
use atipicial_vm::evaluation_stack::EvaluationStack;
use atipicial_vm::interop_service::InteropHost;
use atipicial_vm::script::Script;
...
use atipicial_payloads::{LogEventArgs, NotifyEventArgs, TransactionAttribute, VerifiableContainer};
use atipicial_primitives::{CallFlags, ContractParameterType, FindOptions};
use atipicial_storage::SeekDirection;
use atipicial_storage::{DataCache, EmptyCacheBacking};
use atipicial_vm::{StackItem, VmError, VmResult};
...
use atipicial_primitives::WitnessRuleAction;
...
// Keys are the same closed Atipicial syscall IDs validated by InteropService. Keep
...
/// Atipicial N3 application engine that hosts VM execution, syscalls, and native contracts.
