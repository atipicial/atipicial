...
const LOOKUP_EVIDENCE_DIGEST_DOMAIN: &[u8] =
    b"atipicial-state-packs/materialized-lookup-evidence/v4\0";
const SAMPLE_KEYSET_DIGEST_DOMAIN: &[u8] = b"atipicial-state-packs/materialized-lookup-keyset/v2\0";
const FRAME_REFERENCE_DIGEST_DOMAIN: &[u8] =
    b"atipicial-state-packs/materialized-frame-reference/v2\0";
const SYNTHETIC_MISS_DIGEST_DOMAIN: &[u8] =
    b"atipicial-state-packs/materialized-synthetic-miss/v2\0";
