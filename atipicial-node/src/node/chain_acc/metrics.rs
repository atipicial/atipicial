...
pub(super) struct StateServiceMptImportMetrics {
    ...
    pub(super) atipicialtoken_onpersist_hot_stage: &'static str,
    pub(super) atipicialtoken_onpersist_hot_stage_avg_us: u64,
    pub(super) atipicialtoken_committee_compute_hot_stage: &'static str,
    pub(super) atipicialtoken_committee_compute_hot_stage_avg_us: u64,
    pub(super) atipicialtoken_committee_candidate_hot_kind: &'static str,
    pub(super) atipicialtoken_committee_candidate_hot_avg: u64,
...
pub(super) struct StateServiceMptCumulativeMetrics {
    apply: atipicial_state_service::StateRootApplyStats,
    stages: Vec<atipicial_state_service::metrics::StateRootApplyStageStats>,
    counts: Vec<atipicial_state_service::metrics::StateRootApplyCountStats>,
}
...
pub(super) struct MdbxCommitCumulativeMetrics {
    stats: atipicial_storage::mdbx::MdbxCommitStats,
    stages: Vec<atipicial_storage::mdbx::MdbxCommitStageStats>,
    counts: Vec<atipicial_storage::mdbx::MdbxCommitCountStats>,
}
...
pub(super) struct NativePersistTxCumulativeMetrics {
    stages: Vec<atipicial_runtime::sync_metrics::NativePersistTxStageStats>,
}
...
impl NativePersistTxStageImportMetrics {
    pub(super) fn from_stats(
        stages: &[atipicial_runtime::sync_metrics::NativePersistTxStageStats],
    ) -> Self {
...
impl NativePersistTxCumulativeMetrics {
    pub(super) fn current() -> Self {
        Self::from_stats(atipicial_runtime::sync_metrics::native_persist_tx_stage_stats())
    }
    ...
    pub(super) fn stages(&self) -> &[atipicial_runtime::sync_metrics::NativePersistTxStageStats] {
        &self.stages
    }
...
impl StateServiceMptCumulativeMetrics {
    pub(super) fn current() -> Self {
        Self::from_stats(
            atipicial_state_service::StateRootApplyMetrics::state_root_apply_stats(),
            atipicial_state_service::StateRootApplyMetrics::state_root_apply_stage_stats(),
            atipicial_state_service::StateRootApplyMetrics::state_root_apply_count_stats(),
        )
    }
...
impl StateServiceMptImportMetrics {
    pub(super) fn current() -> Self {
        Self::from_direct_hot_snapshot(
            ...
            atipicial_state_service::StateRootApplyMetrics::state_root_apply_stats(),
            atipicial_state_service::StateRootApplyMetrics::state_root_apply_hot_stats(),
            atipicial_runtime::sync_metrics::native_contract_hook_hot_stats(),
            atipicial_runtime::sync_metrics::native_persist_tx_hot_stats(),
            atipicial_runtime::sync_metrics::atipicial_coin_onpersist_hot_stats(),
            atipicial_runtime::sync_metrics::atipicial_coin_committee_compute_hot_stats(),
            atipicial_runtime::sync_metrics::atipicial_coin_committee_candidate_hot_stats(),
        )
    }
    ...
    pub(super) fn from_direct_hot_snapshot(
        ...
        apply: atipicial_state_service::StateRootApplyStats,
        apply_hot: atipicial_state_service::metrics::StateRootApplyHotStats,
        native_hook_hot: Option<atipicial_runtime::sync_metrics::NativeContractHookStats>,
        native_tx_hot: Option<atipicial_runtime::sync_metrics::NativePersistTxStageStats>,
        atipicialtoken_onpersist_hot: Option<atipicial_runtime::sync_metrics::AtipicialCoinOnPersistStageStats>,
        atipicialtoken_committee_hot: Option<
            atipicial_runtime::sync_metrics::AtipicialCoinCommitteeComputeStageStats,
        >,
        atipicialtoken_candidate_hot: Option<
            atipicial_runtime::sync_metrics::AtipicialCoinCommitteeCandidateCountStats,
        >,
    ) -> Self {
        Self {
            ...
            atipicialtoken_onpersist_hot_stage: atipicialtoken_onpersist_hot.map_or("", |stat| stat.stage),
            atipicialtoken_onpersist_hot_stage_avg_us: atipicialtoken_onpersist_hot
                .map_or(0, |stat| stat.avg_us),
            atipicialtoken_committee_compute_hot_stage: atipicialtoken_committee_hot
                .map_or("", |stat| stat.stage),
            atipicialtoken_committee_compute_hot_stage_avg_us: atipicialtoken_committee_hot
                .map_or(0, |stat| stat.avg_us),
            atipicialtoken_committee_candidate_hot_kind: atipicialtoken_candidate_hot
                .map_or("", |stat| stat.kind),
            atipicialtoken_committee_candidate_hot_avg: atipicialtoken_candidate_hot.map_or(0, |stat| stat.avg),
...
impl SyncHotPathMetrics {
    fn current() -> Self {
        Self {
            blocks_persisted: atipicial_runtime::sync_metrics::blocks_persisted(),
            avg_total_us: atipicial_runtime::sync_metrics::avg_total_us(),
            avg_verify_us: atipicial_runtime::sync_metrics::avg_verify_us(),
            avg_persist_us: atipicial_runtime::sync_metrics::avg_persist_us(),
            avg_commit_us: atipicial_runtime::sync_metrics::avg_commit_us(),
            native_persist_avg_total_us: atipicial_runtime::sync_metrics::native_persist_avg_total_us(),
            native_persist_avg_onpersist_us:
                atipicial_runtime::sync_metrics::native_persist_avg_onpersist_us(),
            native_persist_avg_tx_us: atipicial_runtime::sync_metrics::native_persist_avg_tx_us(),
            native_persist_avg_postpersist_us:
                atipicial_runtime::sync_metrics::native_persist_avg_postpersist_us(),
            native_persist_avg_cache_commit_us:
                atipicial_runtime::sync_metrics::native_persist_avg_cache_commit_us(),
            native_persist_avg_tx_count: atipicial_runtime::sync_metrics::native_persist_avg_tx_count(),
        }
    }
}
