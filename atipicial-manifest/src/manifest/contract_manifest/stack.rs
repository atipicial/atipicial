...
use atipicial_vm::{Interoperable, InteroperableError, StackItem, VmOrderedDictionary};
...
impl ContractManifest {
    ...
    pub fn to_stack_item(&self) -> StackItem {
        ...
        let extra_bytes = match &self.extra {
            Some(extra) => {
                atipicial_serialization::JsonSerializer::encode_value_csharp_compatible(extra.as_value())
            }
            None => b"null".to_vec(),
        };
