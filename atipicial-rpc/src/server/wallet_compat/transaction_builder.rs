//! Atipicial v3.10.1 `Atipicial.Wallets.Wallet.MakeTransaction` parity paths.
...
use atipicial_wallets::{TransferOutput, Wallet, WalletAccount};
...
use super::probes::{
    CallArg, emit_dynamic_call, gas_balance_of, aep17_balance_of, run_test_invocation,
};
    ...
    W: Wallet + ?Sized,
{
    ...
    Err(WalletCompatError::InsufficientFunds(
        "Insufficient ATD balance to cover system and network fees. Please ensure your account \
...
/// builds the AEP-17 transfer script from the outputs and the paying
