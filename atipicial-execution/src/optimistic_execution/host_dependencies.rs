...
use atipicial_vm::NativeCacheDomain;
...
pub enum OptimisticContextValue {
    ...
    I64(i64),
    /// Trigger flags.
    Trigger(atipicial_primitives::TriggerType),
    /// Effective call flags encoded as their exact byte.
    CallFlags(u8),
    /// Optional executing/calling/entry script hash.
    Hash160(Option<atipicial_primitives::UInt160>),
    /// Optional script-container hash.
    Hash256(Option<atipicial_primitives::UInt256>),
