//! # atipicial-manifest::manifest
//!
//! Contract manifest, ABI, permission, and AEF-adjacent metadata types.
//!
//! ## Boundary
//!
//! This module belongs to `atipicial-manifest`. This module belongs to atipicial-manifest
