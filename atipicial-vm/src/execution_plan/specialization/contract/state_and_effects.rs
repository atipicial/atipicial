...
#[derive(Clone, Copy, Debug, Eq, Hash, PartialEq)]
pub enum GasAmount {
    /// One fixed fee in AtipicialVM gas units.
    Fixed(u64),
    ...
    ArgumentBytes {
        ...
        /// Fixed base fee.
        base: u64,
        /// Fee per AtipicialVM-converted byte.
        per_byte: u64,
    },
}
...
pub enum InstructionCount {
    ...
    ArgumentBytes {
        ...
        base: u64,
        /// Additional instructions per AtipicialVM-converted byte.
        per_byte: u64,
    },
}
...
pub enum FaultClass {
    ...
    OutOfGas,
    /// AtipicialVM stack underflow or overflow.
    Stack,
    /// Unsupported or invalid stack-item type/value.
    InvalidType,
    /// AtipicialVM arithmetic or invalid-operation fault.
    InvalidOperation,
...
pub enum HostEffectContract {
    ...
    SlotWrite {
        ...
        index: u16,
        /// Possible freshly computed AtipicialVM value shapes.
...
impl StackEffectContract {
    ...
    /// recursive AtipicialVM reference count immediately before the ordinary first
