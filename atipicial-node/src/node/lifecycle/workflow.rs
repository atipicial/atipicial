...
type ComposedNode = atipicial_system::Node<atipicial_native_contracts::StandardNativeProvider, RuntimeStore>;
...
pub(in crate::node) struct RunningNode {
    ...
    specialization_control: Option<atipicial_execution::specialization::SpecializationControl>,
}
...
impl RunningNode {
    ...
    #[cfg(test)]
    pub(in crate::node) fn network(&self) -> &atipicial_network::NetworkHandle {
        &self.network
    }
    ...
    pub(in crate::node) fn specialization_control(
        &self,
    ) -> Option<&atipicial_execution::specialization::SpecializationControl> {
