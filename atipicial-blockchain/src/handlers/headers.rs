    ...
    M: MempoolLike,
{
    ...
    pub(crate) fn handle_headers(&self, headers: Vec<Header>) -> HeaderValidationOutcome {
        ...
        // header still crosses the ordered canonical AtipicialVM fence before it is
        ...
        for header in headers.into_iter() {
            ...
            // consensus witness satisfies the anchor's NextConsensus (3-ATD cap).
            ...
            if let (Some(snap), Some(prev_header)) = (&snapshot, &prev) {
                ...
                if atipicial_execution::Helper::verify_witness_with_native_provider(
                    &header,
                    settings.as_ref(),
                    snap,
                    &next_consensus,
    ...
    fn handle_headers_with_optimistic_pool(
        ...
        settings: Arc<atipicial_config::ProtocolSettings>,
        snapshot: Arc<atipicial_storage::DataCache<S::CacheBacking>>,
    ...
    fn drain_header_preverification_ticket(
        ...
        snapshot: &atipicial_storage::DataCache<S::CacheBacking>,
        native_contract_provider: Arc<S::NativeProvider>,
    ) -> HeaderTicketDrain {
    ...
    fn verify_header_witness_with_preverification(
        ...
        match signature_cache {
            Some(signature_cache) => {
                ...
                let result =
                    atipicial_execution::Helper::verify_witness_with_native_provider_and_signature_cache(
                        header,
                        settings,
                        snapshot,
            ...
            None => atipicial_execution::Helper::verify_witness_with_native_provider(
                header,
                settings,
                snapshot,
                &parent.next_consensus,
