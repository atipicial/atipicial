...
ALLOWED_CRATE_ROOT_FILES_BY_CRATE = {
    "atipicial-vm": {"THIRD_PARTY_NOTICES.md"},
}
ALLOWED_CRATE_SRC_ROOT_FILES_BY_CRATE = {
    "atipicial-vm": {"execution_profile.rs"},
}
...
class RepositoryHygieneTests(unittest.TestCase):
    ...
    def test_cleaned_crate_test_roots_stay_thin(self):
        crate_test_roots = {
            REPO_ROOT / "atipicial-blockchain" / "src" / "tests": set(),
            REPO_ROOT / "atipicial-config" / "src" / "tests": set(),
            REPO_ROOT / "atipicial-consensus" / "src" / "tests": set(),
            REPO_ROOT / "atipicial-crypto" / "src" / "tests": {"lib.rs", "mpt_trie.rs"},
            REPO_ROOT / "atipicial-error" / "src" / "tests": set(),
            REPO_ROOT / "atipicial-execution" / "src" / "tests": set(),
            REPO_ROOT / "atipicial-hsm" / "src" / "tests": set(),
            REPO_ROOT / "atipicial-indexer" / "src" / "tests": {"lib.rs"},
            REPO_ROOT / "atipicial-io" / "src" / "tests": set(),
            REPO_ROOT / "atipicial-manifest" / "src" / "tests": set(),
            REPO_ROOT / "atipicial-mempool" / "src" / "tests": set(),
            REPO_ROOT / "atipicial-primitives" / "src" / "tests": {"mod.rs"},
            REPO_ROOT / "atipicial-native-contracts" / "src" / "tests": {
                "lib.rs",
                "test_support.rs",
            },
            REPO_ROOT / "atipicial-network" / "src" / "tests": set(),
            REPO_ROOT / "atipicial-node" / "src" / "tests": set(),
            REPO_ROOT / "atipicial-oracle-service" / "src" / "tests": set(),
            REPO_ROOT / "atipicial-payloads" / "src" / "tests": set(),
            REPO_ROOT / "atipicial-rpc" / "src" / "tests": set(),
            REPO_ROOT / "atipicial-runtime" / "src" / "tests": set(),
            REPO_ROOT / "atipicial-serialization" / "src" / "tests": set(),
            REPO_ROOT / "atipicial-state-service" / "src" / "tests": set(),
            REPO_ROOT / "atipicial-storage" / "src" / "tests": set(),
            REPO_ROOT / "atipicial-system" / "src" / "tests": set(),
            REPO_ROOT / "atipicial-vm" / "src" / "tests": set(),
            REPO_ROOT / "atipicial-wallets" / "src" / "tests": set(),
        }
