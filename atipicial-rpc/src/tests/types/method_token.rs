//! Tests for the transport-neutral method-token RPC model.
...
fn method_token_to_json_uses_named_flags() {
    let token = RpcMethodToken {
        method_token: MethodToken {
            hash: UInt160::from([
                0x0e, 0x1b, 0x9b, 0xfa, 0xa4, 0x4e, 0x60, 0x31, 0x1f, 0x6f, 0x3c, 0x96, 0xcf, 0xcd,
                0x6d, 0x12, 0xc2, 0xfc, 0x3a, 0xdd,
            ]),
            method: "test".into(),
            parameters_count: 1,
            has_return_value: true,
