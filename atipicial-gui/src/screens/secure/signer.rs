...
pub fn ui(app: &mut AtipicialGuiApp, ui: &mut Ui) {
    ...
    widgets::card(ui, |ui| {
        ui.label(
            egui::RichText::new(
                "All cloud HSM backends sign with secp256r1 (Atipicial's curve) and keep the key in the HSM/enclave. \
