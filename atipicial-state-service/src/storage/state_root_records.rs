...
use atipicial_storage::StorageError;
...
pub enum StateRootRecordError {
    ...
    /// Full Atipicial state-root decoding failed.
    Decode {
        /// Atipicial binary codec failure.
        source: IoError,
    },
...
/// Decodes exactly one current-version Atipicial StateService root record.
