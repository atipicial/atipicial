...
//!
//! `StorageItem` itself is canonical in `atipicial-storage` (a leaf storage crate).
...
use atipicial_io::{IoResult, MemoryReader};
use atipicial_storage::{StorageItem, StorageItemCache};
