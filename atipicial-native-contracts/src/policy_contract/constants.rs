...
pub const DEFAULT_MAX_VALID_UNTIL_BLOCK_INCREMENT: u32 =
    atipicial_primitives::constants::DEFAULT_MAX_VALID_UNTIL_BLOCK_INCREMENT;
...
/// Single-sourced from `atipicial_execution` (C# `ApplicationEngine.FeeFactor`).
pub(crate) use atipicial_execution::application_engine::FEE_FACTOR;
