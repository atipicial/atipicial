...
/// `Equals(StackItem)` override in `atipicial_csharp_vm/src/Atipicial.VM/Types`:
...
impl StackItem {
    ...
    fn equals_with_refs(
        ...
        // C# Atipicial VM PrimitiveType.Equals is TYPE-STRICT: only items of the SAME
        ...
        let result = match (self, other) {
            ...
            // Buffer uses reference equality (compound type in C# Atipicial VM).
