...
atipicial_io::impl_default_via_new!(WitnessConditionBuilder);
...
atipicial_io::impl_default_via_new!(AndConditionBuilder);
...
atipicial_io::impl_default_via_new!(OrConditionBuilder);
