//! NotifyEventArgs - matches C# Atipicial.SmartContract.NotifyEventArgs exactly.
//!
...
//! type without taking a dependency on the full `atipicial-execution`
...
use atipicial_vm::{Interoperable, InteroperableError, StackItem, VmError};
use std::fmt;
use std::sync::Arc;
