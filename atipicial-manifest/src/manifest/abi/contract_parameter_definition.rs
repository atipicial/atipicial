//! ContractParameterDefinition - matches C# Atipicial.SmartContract.Manifest.ContractParameterDefinition exactly
...
impl ContractParameterDefinition {
    ...
    /// Converts to a atipicial-vm stack item (matches C# `ContractParameterDefinition.ToStackItem` layout).
    ...
    /// Updates this definition from a atipicial-vm stack item.
