...
//! its curve and serialization behavior matches Atipicial wallet requirements. This
//! module is intentionally narrow: it exposes the exact HMAC-SHA512 and
//! modulo-curve-order child-key primitives required by existing Atipicial wallet code
