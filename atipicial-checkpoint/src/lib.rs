//! # Atipicial checkpoint formats
//!
//! This crate owns bounded V1 data types and format identities. It deliberately
//! has no storage, network, AtipicialFs, VM, StateService, or node-composition
...
//!
//! AtipicialFs object identifiers are transport locations only. The authoritative
...
//! node startup, StateService integration, or AtipicialVM execution.
//!
//! ## Contents
//!
