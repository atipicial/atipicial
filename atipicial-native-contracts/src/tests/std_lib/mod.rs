//! # atipicial-native-contracts::tests::std_lib
//!
...
fn resolved_dispatch_indices_cover_all_std_lib_methods_without_gaps() {
    ...
    use atipicial_execution::native_contract_provider::NoNativeContractProvider;
    use atipicial_execution::{ApplicationEngine, NativeContract, NoDiagnostic};
    use atipicial_primitives::TriggerType;
    use atipicial_storage::EmptyCacheBacking;
