//! ContractEventDescriptor - matches C# Atipicial.SmartContract.Manifest.ContractEventDescriptor exactly
...
impl ContractEventDescriptor {
    ...
    /// Converts to a atipicial-vm stack item (matches C# `ContractEventDescriptor.ToStackItem` layout).
    ...
    /// Updates this event descriptor from a atipicial-vm stack item.
