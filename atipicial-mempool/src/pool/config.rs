...
//! network identity remain in `atipicial-config`; pool capacity is deliberately not
...
///
/// This value is owned by `atipicial-mempool`, not by the chain specification. A
