...
//! Witness - Transaction signature verification for Atipicial N3.
//!
//! This module provides the `Witness` struct, which contains the scripts needed
//! to verify transaction signatures on the Atipicial blockchain.
//!
//! ## Overview
//!
...
atipicial_io::impl_default_via_new!(Witness);
...
impl Serializable for Witness {
    ...
    fn serialize(&self, writer: &mut atipicial_io::BinaryWriter) -> atipicial_io::IoResult<()> {
    ...
    fn deserialize(reader: &mut atipicial_io::MemoryReader) -> atipicial_io::IoResult<Self> {
