...
def rpc_call(url: str, method: str, params: list):
    ...
    req = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "atipicial-rs-v310-checkpoints/1.0",
        },
        method="POST",
    )
...
def main():
    parser = argparse.ArgumentParser(
        description="Check local Atipicial v3.10.1 replay against mainnet compatibility checkpoints."
    )
    parser.add_argument("--local-rpc", required=True)
    parser.add_argument(
        "--public-rpc",
        default="https://mainnet1.atipicial.coz.io:443",
