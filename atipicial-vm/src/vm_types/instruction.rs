//! Shared AtipicialVM instruction parsing and operand decoding.
...
/// Result type for shared AtipicialVM instruction operations.
pub type InstructionResult<T> = Result<T, InstructionError>;

/// Represents a parsed AtipicialVM instruction.
#[derive(Debug, Clone, PartialEq, Eq)]
