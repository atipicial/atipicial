//! Type operations for the Atipicial Virtual Machine.
//!
//! This module provides the type operation handlers for the Atipicial VM.
...
mod tests {
    ...
    #[test]
    fn primitive_byte_conversions_match_atipicialvm_memory() {
        assert!(matches!(
