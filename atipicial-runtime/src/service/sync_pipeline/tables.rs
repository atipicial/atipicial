...
use atipicial_storage::persistence::{Table, TableDecode, TableEncode, TableNamespace};
use atipicial_storage::{StorageError, StorageResult};

#[cfg(test)]
use atipicial_storage::persistence::IntoTableBytes;

use super::{HeaderStageWindow, MAX_VERIFIED_HEADER_WINDOW, SyncStageCheckpoint, SyncStageKind};
#[cfg(test)]
use crate::{ServiceError, ServiceResult};

const CHECKPOINT_KEY_PREFIX: &[u8] = b"atipicial.sync.stage-checkpoint.v1.";
...
const VERIFIED_HEADER_KEY_PREFIX: &[u8] = b"atipicial.sync.verified-header.v1.header.";
const VERIFIED_HEADER_KEY_LEN: usize = VERIFIED_HEADER_KEY_PREFIX.len() + 4;
const VERIFIED_WINDOW_KEY: &[u8] = b"atipicial.sync.verified-header.v1.window";
const VERIFIED_TARGET_HASH_KEY: &[u8] = b"atipicial.sync.verified-header.v1.target-hash";
