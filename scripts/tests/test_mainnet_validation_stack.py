    ...
    def test_plan_includes_node_validator_and_checkpoint_commands(self):
        ...
        self.assertEqual(
            ...
            [
                ...
                "--config",
                "atipicial_mainnet_validate.toml",
                "--enable-stateroot",
                "--check-all",
            ],
        )
        ...
        self.assertIn("atipicial_mainnet_validate.toml", validator_command)
        ...
        self.assertIn("atipicial_mainnet_validate.toml", checkpoint_command)
        self.assertIn("--writer-pid", checkpoint_command)
        self.assertIn("<atipicial-node-pid>", checkpoint_command)
