//! Canonical catalog for Atipicial's standard native contracts.
...
/// Number of canonical Atipicial N3 native contracts exposed by this crate.
...
fn standard_native_contract_descriptors() -> StandardNativeContractDescriptors {
    [
        ...
        native_contract_descriptor!(AtipicialCoin, AtipicialCoin),
        native_contract_descriptor!(AtipicialDollar, AtipicialDollar),
...
/// Returns `true` when `hash` is one of the 11 standard Atipicial N3 native
