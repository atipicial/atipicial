...
use super::super::super::json::atipicialfs_json_header;
#[cfg(feature = "atipicialfs-grpc")]
...
#[cfg(feature = "atipicialfs-grpc")]
#[test]
fn atipicialfs_json_header_matches_csharp_format() {
    ...
    let header = atipicialfs_v2::object::Header {
        version: Some(atipicialfs_v2::refs::Version {
            major: 2,
            minor: 11,
        }),
        container_id: Some(atipicialfs_v2::refs::ContainerId {
            value: container_bytes,
        }),
        owner_id: Some(atipicialfs_v2::refs::OwnerId { value: owner_bytes }),
        creation_epoch: 42,
        payload_length: 512,
        payload_hash: Some(atipicialfs_v2::refs::Checksum {
            r#type: atipicialfs_v2::refs::ChecksumType::Sha256 as i32,
            sum: checksum_bytes,
        }),
        object_type: atipicialfs_v2::object::ObjectType::Lock as i32,
        homomorphic_hash: None,
        session_token: None,
        attributes: vec![atipicialfs_v2::object::header::Attribute {
            key: "k".to_string(),
            value: "v".to_string(),
        }],
        split: None,
    ...
    let json = atipicialfs_json_header(&header).expect("header json");
