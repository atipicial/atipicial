...
use atipicial_storage::persistence::{CacheRead, DataCache, EmptyCacheBacking, StoreCacheBacking};
use std::sync::Arc;
use uuid::Uuid;
...
type SessionEngine<B> =
    ApplicationEngine<atipicial_native_contracts::StandardNativeProvider, Option<Diagnostic>, B>;
