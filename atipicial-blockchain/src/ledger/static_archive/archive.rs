...
use atipicial_static_files::{StaticFileArchive, StaticFileProvider, StaticRecord};
...
fn static_file_error(context: &'static str, error: atipicial_static_files::StaticFileError) -> CoreError {
