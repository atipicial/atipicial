//! # atipicial-node::process::lifecycle_lock
//!
...
mod tests {
    ...
    const HOLDER_DIRECTORY_ENV: &str = "ATC_NODE_LOCK_TEST_HOLDER_DIRECTORY";
    const HOLDER_READY_ENV: &str = "ATC_NODE_LOCK_TEST_HOLDER_READY";
    ...
    fn rejects_contention_from_another_process() {
        ...
        let mut child = Command::new(test_binary)
            .args([
                "--exact",
                "process::lifecycle_lock::tests::subprocess_lock_holder",
                "--nocapture",
            ])
