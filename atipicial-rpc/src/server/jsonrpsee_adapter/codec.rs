...
//! conversion between jsonrpsee's raw parameter/error types and Atipicial's RPC error
//! catalog.
...
/// Decode jsonrpsee raw params as the positional array expected by Atipicial RPC
/// handlers.
...
/// Project a Atipicial RPC error into jsonrpsee's owned JSON-RPC error object.
