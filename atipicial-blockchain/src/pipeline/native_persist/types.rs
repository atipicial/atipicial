    ...
    P: NativeContractProvider + 'static,
{
    ...
    /// invokes the isolated shadow runner and commits its ordinary AtipicialVM branch.
    #[must_use]
...
impl<B: CacheRead> StagedNativePersist<B> {
    ...
    pub fn commit(&self) {
        ...
        let cache_commit_us = atipicial_runtime::time::elapsed_us(cache_commit_start.elapsed());
        let total_us = atipicial_runtime::time::elapsed_us(self.total_start.elapsed());
        atipicial_runtime::sync_metrics::record_native_persist(
