//! Wallet: open a AEP-6 wallet on the node and inspect its accounts.
//!
...
pub fn ui(app: &mut AtipicialGuiApp, ui: &mut Ui) {
    ...
    ui.label(
        egui::RichText::new(
            "Open a AEP-6 wallet on the node and view its accounts. Requires wallet RPC methods enabled.",
        )
