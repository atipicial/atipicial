//! # atipicial-rpc::client::models
//!
//! Client-side RPC request and response models for atipicial-rpc.
//!
//! ## Boundary
//!
...
//! - `rpc_aep17_balances`: AEP-17 balances RPC model.
//! - `rpc_aep17_token_info`: AEP-17 token-info RPC model.
//! - `rpc_aep17_transfers`: AEP-17 transfer RPC model.
//! - `rpc_aep11_balances`: AEP-11 balances RPC model.
//! - `rpc_aep11_transfers`: AEP-11 transfer RPC model.
...
//! - `rpc_unclaimed_gas`: unclaimed ATD RPC model.
...
// AEP17 token types
/// AEP-17 balance response models.
#[path = "tokens/rpc_aep17_balances.rs"]
pub mod rpc_aep17_balances;
/// AEP-17 token information model.
#[path = "tokens/rpc_aep17_token_info.rs"]
pub mod rpc_aep17_token_info;
/// AEP-17 transfer response models.
#[path = "tokens/rpc_aep17_transfers.rs"]
pub mod rpc_aep17_transfers;

// AEP11 token types
/// AEP-11 balance response models.
#[path = "tokens/rpc_aep11_balances.rs"]
pub mod rpc_aep11_balances;
/// AEP-11 transfer response models.
#[path = "tokens/rpc_aep11_transfers.rs"]
pub mod rpc_aep11_transfers;
...
pub use rpc_aep11_balances::{RpcAep11Balance, RpcAep11Balances, RpcAep11TokenBalance};
pub use rpc_aep11_transfers::{RpcAep11Transfer, RpcAep11Transfers};
pub use rpc_aep17_balances::{RpcAep17Balance, RpcAep17Balances};
pub use rpc_aep17_token_info::RpcAep17TokenInfo;
pub use rpc_aep17_transfers::{RpcAep17Transfer, RpcAep17Transfers};
...
pub use rpc_unclaimed_gas::RpcUnclaimedAtipicialDollar;
