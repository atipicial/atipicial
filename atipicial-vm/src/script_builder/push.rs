...
//!
//! This module owns the mechanics for turning Rust/VM values into AtipicialVM push
...
impl ScriptBuilder {
    ...
    /// Emits a push operation for a local AtipicialVM stack item.
...
mod tests {
    ...
    fn pushing_struct_emits_packstruct_while_array_emits_pack() {
        // Atipicial v3.10.1 SmartContract/Helper.cs EmitPush(StackItem) preserves the
