...
//!
//! Mirrors the vote/aggregate flow of C# `Atipicial.Plugins.StateService`:
//! 1. Each designated **StateValidator** signs the sign-data of a locally
//!    computed [`atipicial_state_service::StateRoot`] (`network || Hash`) and
//!    broadcasts a `Vote`.
...
struct StateRootIdentity {
    version: u8,
    index: u32,
    root_hash: atipicial_primitives::UInt256,
}
