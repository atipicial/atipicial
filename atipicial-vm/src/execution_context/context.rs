...
//! Execution context module for the Atipicial Virtual Machine.
//!
//! This module provides the execution context implementation for the Atipicial VM.
...
/// Represents an execution context in the Atipicial Virtual Machine.
...
impl<S> ExecutionContext<S> {
    ...
    ///
    /// Atipicial.VM permits the position immediately after the script so the engine
