...
//!
//! All HSM errors map to [`atipicial_consensus::error::ConsensusError`] via
...
atipicial_error::impl_error_from_struct!(atipicial_error::CoreError, HsmError => Cryptographic);
