//! Atipicial MPT proof construction and verification.
...
use super::super::cache::{MptStoreSnapshot, node_key_bytes};
use super::super::error::{MptError, MptResult};
use super::super::node::{BRANCH_VALUE_INDEX, Node};
use super::super::node_type::NodeType;
use super::super::{MPT_NODE_PREFIX, MptCache};
