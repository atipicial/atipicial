...
class DiagnosePersistFailureTests(unittest.TestCase):
    ...
    def test_gas_account_storage_key_uses_aep17_account_prefix_and_address_hash(self):
        module = load_module()
    ...
    def test_decode_aep17_account_balance_reads_account_state_struct(self):
        module = load_module()

        self.assertEqual(module.decode_aep17_account_balance("QQEhBEGk/QI="), 50177089)
        self.assertEqual(module.decode_aep17_account_balance(""), 0)
