...
//!
//! These tests ensure full compatibility with C# Atipicial's BinaryWriter functionality.
//! Tests are based on the C# Atipicial.IO.BinaryWriter test suite.
...
mod tests {
    ...
    fn test_write_var_int_compatibility() {
        // Test cases from C# Atipicial implementation
        let test_cases = vec![
            (0u64, vec![0x00]),
            (1u64, vec![0x01]),
            (252u64, vec![0xFC]),
    ...
    fn test_write_var_string_compatibility() {
        ...
        let test_cases = vec![
            ...
            ("Atipicial", vec![0x03, 0x4E, 0x65, 0x6F]),
            ("✓Atipicial", vec![0x06, 0xE2, 0x9C, 0x93, 0x4E, 0x65, 0x6F]),
        ];
    ...
    fn test_round_trip_compatibility() {
        ...
        writer.write_var_string("Hello Atipicial").unwrap();
        ...
        assert_eq!(string_val, "Hello Atipicial");
        assert!(bool_val);
