//! Hardfork enumeration for Atipicial blockchain.
//!
//! Matches C# Atipicial.Hardfork enum exactly.
...
protocol_enum_repr! {
    ...
    /// Represents a hardfork in the Atipicial blockchain (matches C# Hardfork enum exactly).
    ///
    /// Hardforks are named after mythological creatures in alphabetical order.
    #[derive(Debug, Clone, Copy, PartialEq, Eq, Hash, PartialOrd, Ord, Serialize, Deserialize)]
    pub Hardfork {
        /// Aspidochelone hardfork - First Atipicial N3 hardfork.
...
#[cfg(test)]
#[path = "../../tests/protocol/chain/hardfork.rs"]
mod tests;
