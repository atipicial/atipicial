//! Async service traits for the Atipicial node runtime.
//!
...
//! Concrete composition lives above this crate in `atipicial-system` and the runnable
//! `atipicial-node` daemon.
//!
...
//! (`atipicial-mempool`) is reached through the blockchain/node-service wiring.
...
/// Marker trait implemented by every Atipicial runtime service.
///
