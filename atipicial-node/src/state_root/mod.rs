...
//! `atipicial-blockchain` (`atipicial_blockchain::StateRootVoteCollector`,
//! `atipicial_blockchain::verify_state_root_with_native_provider`); this module is
//! the node-side driver that feeds it network payloads and persists the
//! finalized signed root.
//!
//! ## C# reference
//!
//! Mirrors `Atipicial.Plugins.StateService`:
