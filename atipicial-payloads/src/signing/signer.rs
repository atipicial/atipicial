...
use atipicial_io::macros::{OptionExt, ValidateLength};
...
use atipicial_primitives::{UINT160_SIZE, UInt160, WitnessScope};
...
impl Signer {
    ...
    /// Converts the signer to a atipicial-vm stack item (matches C# `Signer.ToStackItem` layout).
...
atipicial_io::impl_hash_for_fields!(Signer, account, scopes);
