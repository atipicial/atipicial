//! # atipicial-native-contracts::tests::native_manifest_pinning
//!
//! Test module grouping native manifest pinning behavior coverage for atipicial-
//! native-contracts.
//!
//! ## Boundary
//!
...
use atipicial_config::{Hardfork, HardforkSchedule, ProtocolSettings};
use atipicial_execution::native_contract::{NativeContract, build_native_contract_state};
...
use atipicial_native_contracts::{
    ...
    OracleContract, PolicyContract, RoleManagement, StandardNativeProvider, StdLib, Treasury,
