...
//! ## Boundary
//!
//! This module belongs to `atipicial-blockchain`. This node-service crate owns the
...
//! - `stage_traits`: pipeline stage trait definitions (ADR-027, moved from atipicial-engine).
