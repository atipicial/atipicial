//! WildCardContainer - matches C# Atipicial.SmartContract.Manifest.WildCardContainer exactly
...
use atipicial_vm::impl_interoperable_via_stack_item;
...
impl WildCardContainer<String> {
    ...
    /// Converts from a atipicial-vm stack item.
    ...
    /// Converts the container to a atipicial-vm stack item.
