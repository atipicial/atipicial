...
#![doc(html_root_url = "https://docs.rs/atipicial-error/0.11.1")]
...
// `atipicial-io` so consumers of `CoreError` (and `IoError`-adjacent error types) can
// use the same boilerplate-reducing helpers without depending on `atipicial-io`
// macros directly. The macros themselves still live in `atipicial-io` (they are
// generic helpers, not specific to this crate).
#[doc(inline)]
pub use atipicial_io::impl_error_from;
#[doc(inline)]
pub use atipicial_io::impl_error_from_struct;
