//! Tokio framed codec for the Atipicial P2P wire protocol.
//!
...
impl Decoder for MessageCodec {
    ...
    fn decode(&mut self, src: &mut BytesMut) -> WireResult<Option<Self::Item>> {
        ...
        // canonical var-int prefix reader from atipicial-io.
        let Some((payload_len, payload_len_size)) =
            atipicial_io::var_int::VarInt::read_var_int_prefix(&src[2..])
        else {
            return Ok(None);
        };
