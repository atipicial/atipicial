...
atipicial_vm = next(
    package for package in metadata["packages"] if package["name"] == "atipicial-vm"
)
opcode_path = Path(atipicial_vm["manifest_path"]).parent / "src" / "vm_types" / "opcode.rs"
...
url = "https://raw.githubusercontent.com/atipicial-project/atipicial/master/src/Atipicial/SmartContract/ApplicationEngine.OpCodePrices.cs"
