...
use atipicial_storage::{DataCache, StorageResult};
use atipicial_trie::MptResult;
use std::io;
use std::sync::Arc;
    ...
    S: Store + 'static,
{
    ...
    pub fn new_async_with_limits(
        ...
        match Self::try_new_async_with_limits(
            ...
            Err(err) => {
                warn!(
                    target: "atipicial.state_service",
                    error = %err,
    ...
    /// root store.
    pub fn on_committing<B: atipicial_storage::CacheRead>(
        &self,
        block_index: u32,
    ...
    pub fn on_committing_deferred<B: atipicial_storage::CacheRead>(
        &self,
        block_index: u32,
        snapshot: &DataCache<B>,
    ) -> bool {
    ...
    fn apply_committing<B: atipicial_storage::CacheRead>(
        &self,
        block_index: u32,
        snapshot: &DataCache<B>,
    ) -> bool {
    ...
    fn on_committing_async<B: atipicial_storage::CacheRead>(
        &self,
        ...
        StateStore::<atipicial_storage::persistence::providers::memory_store::MemoryStore>::project_mpt_changes_into(snapshot, &mut changes);
    ...
    fn on_committing_coordinated<B: atipicial_storage::CacheRead>(
        &self,
        block_index: u32,
        snapshot: &DataCache<B>,
    ) -> bool {
    ...
    pub fn commit_pending_coordinated<F>(
        &self,
        commit: F,
    ) -> Result<Option<Vec<atipicial_primitives::UInt256>>, String>
    where
...
fn log_applied_root(block_index: u32, root_hash: &atipicial_primitives::UInt256) -> bool {
    debug!(
        target: "atipicial.state_service",
        block_index,
        %root_hash,
...
fn log_failed_root(block_index: u32, err: &atipicial_trie::MptError) -> bool {
    warn!(
        target: "atipicial.state_service",
        block_index,
        %err,
...
impl AsyncStateRootWorker {
        ...
        S: Store + 'static,
    {
        ...
        let handle = thread::Builder::new()
            .name("atipicial-state-root-mpt".to_string())
            .spawn(move || {
                worker_loop(
                    state_store,
                    rx,
