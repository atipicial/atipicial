...
# Atipicial-rs Fuzzing Infrastructure

This directory contains the fuzzing infrastructure for atipicial-rs, using [cargo-fuzz](https://github.com/rust-fuzz/cargo-fuzz) with libFuzzer.
...
**Target:** `atipicial_core::network::p2p::payloads::transaction::Transaction`
...
**Target:** `atipicial_core::script_validation::validate_script`
...
**Target:** `atipicial_core::network::p2p::message::Message`
