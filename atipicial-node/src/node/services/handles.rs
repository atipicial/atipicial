...
//!
//! Core composition stays in `atipicial-system::Node`; application services that
...
where
    S: Store,
{
    state_store: Option<Arc<atipicial_state_service::StateStore<S>>>,
    state_commit_handlers:
        Option<Arc<atipicial_state_service::commit_handlers::StateServiceCommitHandlers<S>>>,
    indexer: Option<Arc<atipicial_indexer::IndexerService>>,
    application_logs: Option<Arc<atipicial_rpc::application_logs::ApplicationLogsService<S>>>,
    tokens_tracker: Option<Arc<atipicial_rpc::plugins::tokens_tracker::TokensTrackerService<S>>>,
    ...
    S: Store,
{
    ...
    pub(in crate::node) fn new(
        ...
        state_commit_handlers: Option<
            Arc<atipicial_state_service::commit_handlers::StateServiceCommitHandlers<S>>,
        >,
        indexer: Option<Arc<atipicial_indexer::IndexerService>>,
        application_logs: Option<Arc<atipicial_rpc::application_logs::ApplicationLogsService<S>>>,
        tokens_tracker: Option<Arc<atipicial_rpc::plugins::tokens_tracker::TokensTrackerService<S>>>,
    ...
    pub(in crate::node) fn state_store(&self) -> Option<Arc<atipicial_state_service::StateStore<S>>> {
    ...
    pub(in crate::node) fn indexer(&self) -> Option<Arc<atipicial_indexer::IndexerService>> {
    ...
    pub(in crate::node) fn application_logs(
        &self,
    ) -> Option<Arc<atipicial_rpc::application_logs::ApplicationLogsService<S>>> {
    ...
    pub(in crate::node) fn tokens_tracker(
        &self,
    ) -> Option<Arc<atipicial_rpc::plugins::tokens_tracker::TokensTrackerService<S>>> {
    ...
    pub(in crate::node) fn rpc_services(&self) -> atipicial_rpc::server::RpcServices<S> {
        let mut services = atipicial_rpc::server::RpcServices::new();
