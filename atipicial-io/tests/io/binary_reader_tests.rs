...
//!
//! These tests ensure full compatibility with C# Atipicial's BinaryReader functionality.
//! Tests are based on the C# Atipicial.IO.BinaryReader test suite.

use atipicial_io::MemoryReader;
...
mod tests {
    ...
    fn test_read_var_string_compatibility() {
        ...
        let test_cases = vec![
            ...
            (vec![0x03, 0x4E, 0x65, 0x6F], "Atipicial"),
            (vec![0x06, 0xE2, 0x9C, 0x93, 0x4E, 0x65, 0x6F], "✓Atipicial"),
        ];
