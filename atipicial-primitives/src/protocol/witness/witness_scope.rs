...
//!
//! Matches C# `Atipicial.Network.P2P.Payloads.WitnessScope` exactly.
...
define_witness_scope! {
    ...
    pub struct WitnessScope {
        ...
        /// Global scope allows this witness in all contexts (default Atipicial 2 behavior).
...
#[cfg(test)]
#[path = "../../tests/protocol/witness/witness_scope.rs"]
mod tests;
