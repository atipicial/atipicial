//! # atipicial-rpc::server::diagnostic
//!
...
use atipicial_execution::ApplicationExecutionContext as ExecutionContext;
use atipicial_execution::diagnostic::Diagnostic as DiagnosticTrait;
...
/// Diagnostics helper mirroring `Atipicial.Plugins.RpcServer.Diagnostic`.
