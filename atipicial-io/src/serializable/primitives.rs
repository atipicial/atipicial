//! Serializable implementations for atipicial-primitives types.
//!
//! This module provides `Serializable` implementations for primitive types
//! from the atipicial-primitives crate, keeping atipicial-primitives free of atipicial-io dependencies.
