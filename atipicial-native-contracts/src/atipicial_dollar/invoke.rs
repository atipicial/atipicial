...
//!
//! Keeps AEP-17 ABI method bodies out of the contract root while preserving the
...
impl AtipicialDollar {
    ...
    >(
        ...
        let account = crate::args::raw_account(args, "AtipicialDollar::balanceOf")?;
        let snapshot = engine.snapshot_cache();
    ...
    >(
        ...
        let from = crate::args::raw_hash160(args, 0, "AtipicialDollar::transfer")?;
        let to = crate::args::raw_hash160(args, 1, "AtipicialDollar::transfer")?;
        let amount = crate::args::raw_required_integer_arg(
            args,
            2,
            "AtipicialDollar::transfer",
            "an amount",
        )?;
