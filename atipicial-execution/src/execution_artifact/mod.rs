//! # atipicial-execution::execution_artifact
//!
...
//! production execution path and never replace AtipicialVM stack items or execution
...
//! - Deterministic AtipicialVM object-graph encoding for comparison.
