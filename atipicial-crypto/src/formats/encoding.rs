//! Encoding helpers used by Atipicial cryptographic APIs.
//!
//! The module exposes free functions grouped by codec instead of wrapper
//! structs. That keeps the public surface small while preserving Atipicial-specific
...
use atipicial_primitives::base58_check::Base58CheckDecodeError;
...
pub mod base58 {
    ...
    use atipicial_primitives::base58_check::Base58Check;
