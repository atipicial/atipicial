...
//!
//! Usage: `atipicial-pack-marker --mdbx <canonical-store-dir>`
...
use atipicial_state_service::MDBX_STATE_SERVICE_NAMESPACE;
use atipicial_storage::persistence::providers::RuntimeStore;
use atipicial_storage::persistence::storage::StorageConfig;
use atipicial_storage::persistence::{StoreFactory, TransactionalStore};
use serde::Serialize;
