...
//!
//! NOTE: Tests removed after atipicial-chain crate deletion — ChainState/BlockIndexEntry
//! types (PoW concepts, cumulative difficulty, fork choice) are incompatible
//! with Atipicial N3 dBFT 2.0 consensus.
...
use atipicial_storage::persistence::{StoreCache, providers::MemoryStore};
...
async fn native_ledger_records_survive_store_cache_reopen() {
    ...
    let chain_spec = AtipicialChainSpec::mainnet().expect("valid MainNet chain spec");
