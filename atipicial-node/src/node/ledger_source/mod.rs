//! # atipicial-node::node::ledger_source
//!
...
//! ## Contents
//!
//! - `local`: store-backed [`atipicial_network::BlockSource`] implementation for
//!   normal nodes with a local ledger.
//! - `remote`: JSON-RPC-backed [`atipicial_network::BlockSource`] implementation for
//!   remote-ledger mode.
