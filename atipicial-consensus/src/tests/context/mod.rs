//! # atipicial-consensus::tests::context
//!
//! Test module grouping Runtime context records carried through the local
//! workflow. coverage for atipicial-consensus.
//!
//! ## Boundary
//!
//! This is test/benchmark-only code for atipicial-consensus; it may assemble fixtures
...
fn create_test_validators(count: usize) -> Vec<ValidatorInfo> {
    (0..count)
        .map(|i| ValidatorInfo {
            index: i as u8,
            public_key: ECPoint::infinity(atipicial_crypto::ECCurve::Secp256r1),
