//! Atipicial compact integer helpers.
//!
//! These helpers implement the Bitcoin-style compact integer encoding used by
//! Atipicial wire formats and binary serialization. They are intentionally not SCALE,
...
/// Atipicial compact integer (var-int) codec helpers.
pub struct VarInt;
...
impl VarInt {
    ...
    /// Appends `value` using Atipicial compact integer encoding.
    ...
    /// Appends a Atipicial var-bytes payload to `dst`.
