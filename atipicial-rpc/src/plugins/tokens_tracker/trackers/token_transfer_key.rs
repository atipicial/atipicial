//! Base key used for AEP transfer history.
//!
//! Common transfer key structure used by both AEP-11 and AEP-17.

use atipicial_io::{BinaryWriter, IoResult, MemoryReader, Serializable, impl_ord_by_fields};
