//! Mirror of `Atipicial.Network.P2P.ChannelsConfig`.
//!
...
// FrameConfig and PeerConnection moved to atipicial-node (Phase 2 refactoring)
...
pub struct ChannelsConfig {
    ...
    /// Hard cap on simultaatipicialusly connected peers.
    pub max_connections: usize,
    /// Maximum simultaatipicialus connections allowed from the same address.
...
#[cfg(test)]
#[path = "../tests/proto/channels_config.rs"]
mod tests;
