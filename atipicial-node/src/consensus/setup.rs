...
use atipicial_consensus::{ConsensusError, ConsensusResult, ConsensusSigner, ValidatorInfo};
...
///
/// C# dBFT uses `ATC.GetNextBlockValidators(...).OrderBy(p => p)`, which at
...
pub(crate) enum NodeConsensusSigner {
    ...
    #[cfg(feature = "hsm")]
    Pkcs11(atipicial_hsm::Pkcs11Signer),
}
