//! # atipicial-execution execution artifact tests
//!
...
//! and AtipicialVM values. They do not publish ledger state or test node scheduling.
//!
//! ## Contents
//!
...
use atipicial_storage::{DataCache, EmptyCacheBacking, StorageItem, StorageKey};
use atipicial_vm::stack_item::{Array, Map, Struct};
use atipicial_vm::{
