use crate::{Conflicts, NotValidBefore, OracleResponse, OracleResponseCode, TransactionAttribute};
...
atipicial_io::impl_default_via_new!(TransactionAttributesBuilder);

impl TransactionAttributesBuilder {
    /// Creates an empty transaction-attributes builder.
    pub fn new() -> Self {
        Self {
            attributes: Vec::new(),
        }
