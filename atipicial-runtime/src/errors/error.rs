//! Service-layer error type shared by the runtime service traits in `atipicial_runtime`.
//!
...
impl ServiceError {
    ...
    /// value. Mirrors the helper constructors on other Atipicial error types.
...
/// Result alias used by every service method in `atipicial_runtime`.
