//! Atipicial C#-compatible MPT node representation and deterministic codec.
...
///
/// This mirrors the behaviour of `Atipicial.Cryptography.MPTTrie.Node` from the C# reference
...
pub struct Node {
    ...
    ///
    /// Atipicial's MPT implementation stores this as a C# `int`. Keeping the signed
