//! # atipicial-vm::tests::jump_table
//!
//! Test module grouping Opcode dispatch tables and instruction implementations.
//! coverage for atipicial-vm.
//!
//! ## Boundary
//!
//! This is test/benchmark-only code for atipicial-vm; it may assemble fixtures but
...
/// handlers and the pre-`atipicial-vm#567` SHL/SHR implementations, leaving every
