...
VM_FIXTURE = REPO_ROOT / "atipicial-vm/tests/fixtures/csharp-v3.10.1-vm.json"
APPLICATION_FIXTURE = (
    REPO_ROOT / "atipicial-execution/tests/fixtures/csharp-v3.10.1-application.json"
)
...
EXPECTED_ORACLES = {
    VM_FIXTURE: (
        "https://github.com/atipicial-project/atipicial-vm.git",
        "004cd6070a940405818d9357638277dd44407e2e",
    ),
    APPLICATION_FIXTURE: (
        "https://github.com/atipicial-project/atipicial.git",
