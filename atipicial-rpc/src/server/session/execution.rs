...
use atipicial_runtime::StoreProvider;
use atipicial_storage::persistence::{Store, StoreCacheBacking};
...
impl<T: Store> SessionRecord<StoreCacheBacking<T>> {
    ...
    where
        ...
        C: ChainSpecProvider<ChainSpec = AtipicialChainSpec> + ?Sized,
    {
        ...
        // C# `AtipicialSystemExtensions.GetMaxValidUntilBlockIncrement(snapshot,
