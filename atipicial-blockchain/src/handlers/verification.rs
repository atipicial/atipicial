...
use atipicial_execution::{PreverifiedSignatureCache, PreverifiedSignatureCacheMetricsSnapshot};
use atipicial_payloads::block::Block;

use crate::pipeline::consensus_witness_stage::{
    AtipicialConsensusWitnessStage, SnapshotConsensusWitnessContext,
};
    ...
    M: MempoolLike,
{
    ...
    fn verify_consensus_witness_against_snapshot_with_native_provider(
        ...
        let stage = AtipicialConsensusWitnessStage::new(Arc::new(SnapshotConsensusWitnessContext::new(
            chain_spec,
            snapshot,
    ...
    pub(crate) fn try_block_hash(block: &Block) -> CoreResult<atipicial_primitives::UInt256> {
