...
fn oracle_service() -> OracleService<atipicial_system::Node> {
    ...
    let system = Arc::new(atipicial_system::Node::for_test(
        atipicial_test_fixtures::test_chain_spec(settings),
    ));
