//! # atipicial-blockchain::ledger::ledger_provider
//!
//! Provider-style read API over persisted Atipicial ledger records.
//!
//! ## Boundary
//!
//! This module belongs to `atipicial-blockchain`. It owns read-only ledger
