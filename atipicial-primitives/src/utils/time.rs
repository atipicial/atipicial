//! Testable time source for the Atipicial workspace.
//!
...
//! ## Layering
//!
//! Sits in `atipicial-primitives` with the other foundational, no-`atipicial-*`
...
//! `atipicial-system` would force every crate that wants a mockable clock
...
//!
//! ```rust,no_run
//! use atipicial_primitives::{TimeProvider, TimeSource};
//!
//! // Get current time.
