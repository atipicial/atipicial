...
use atipicial_primitives::{TriggerType, UInt160};
...
pub(super) fn run_test_invocation<P, B>(
    ...
    max_gas: i64,
) -> CoreResult<ApplicationEngine<P, atipicial_execution::NoDiagnostic, B>>
where
...
/// `balanceOf` probe for an arbitrary AEP-17 asset.
pub(super) fn aep17_balance_of<P, B>(
    snapshot: &DataCache<B>,
    settings: &ProtocolSettings,
    native_contract_provider: &Arc<P>,
    asset: &UInt160,
