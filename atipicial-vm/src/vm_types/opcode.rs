//! Canonical AtipicialVM opcode metadata.
...
macro_rules! define_opcodes {
    ($(
        ...
        /// AtipicialVM operation codes.
        ///
        /// Values follow the canonical Atipicial N3 opcode assignment used by Atipicial.VM 3.10.1.
