...
//!
//! This adapter shares the node's staged-sync [`atipicial_runtime::BlockImportQueue`]
//! but retains `atipicial-blockchain` inventory semantics after preflight: dBFT
...
use atipicial_runtime::{BlockImportQueue, ServiceResult};
...
/// reject or park it later inside `atipicial-blockchain`.
