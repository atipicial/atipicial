...
//!
//! Mirrors `Atipicial.Network.P2P.Capabilities.NodeCapabilityType`.
...
impl NodeCapabilityType {
    /// Maximum encoded value accepted by the Atipicial protocol for capability bytes.
...
#[cfg(test)]
#[path = "../../tests/protocol/network/node_capability_type.rs"]
mod tests;
