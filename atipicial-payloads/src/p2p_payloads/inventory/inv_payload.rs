//! Inventory payload (mirrors `Atipicial.Network.P2P.Payloads.InvPayload`).
...
/// Maximum number of hashes in an inventory payload.
/// Matches C# Atipicial: `InvPayload.MaxHashesCount = 500`
