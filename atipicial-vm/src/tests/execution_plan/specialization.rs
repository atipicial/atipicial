...
fn base_execution() -> ExecutionPlanKey {
    execution_key(
        &[0x10, 0x11, 0x12, 0x40],
        1,
        ProtocolIdentity::new(MAINNET_MAGIC, ProtocolVersion::ATC_N3_V3_10_1),
        hardforks(),
...
#[test]
fn stack_item_shapes_match_only_declared_atipicial_vm_values() {
...
fn candidate_retains_exact_identity_and_complete_pure_effect_contract() {
    ...
    assert_eq!(
        ...
        ProtocolVersion::ATC_N3_V3_10_1
    );
...
fn registry_lookup_uses_full_exact_execution_identity() {
    ...
    let distinct = [
        ...
        execution_key(
            baseline.script_bytes(),
            1,
            ProtocolIdentity::new(0x1234_5678, ProtocolVersion::ATC_N3_V3_10_1),
            baseline.hardforks(),
            baseline.trigger(),
            baseline.contract(),
        ),
