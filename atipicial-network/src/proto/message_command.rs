//! Message command identifiers (mirrors `Atipicial.Network.P2P.MessageCommand`).

use atipicial_primitives::InventoryType;
use std::{fmt, str::FromStr};

atipicial_primitives::protocol_enum_with_unknown! {
    /// Atipicial message command (single-byte discriminator).
...
impl MessageCommand {
    ...
    /// Returns true when C# Atipicial permits attempting LZ4 compression for this command.
