...
//!
//! `atipicial-blockchain` owns the concrete command loop and persistence pipeline.
...
///
/// The queue mirrors Substrate's `ImportQueue` boundary without owning Atipicial's
