//! `WitnessConditionType` - matches C# Atipicial.Network.P2P.Payloads.WitnessConditionType exactly.
//!
//! This is the single source of truth for witness condition protocol bytes. Both
//! `atipicial-core::witness_rule` and `atipicial-p2p` re-export this type for backward compatibility.
