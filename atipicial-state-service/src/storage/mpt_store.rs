...
//! `atipicial_csharp/src/Plugins/StateService`): one flat key/value namespace
//! holds
//!
//! - the MPT nodes, written by the [`Trie`] write-through cache under
//!   `0xf0 || node_hash` (the prefix is applied inside
//!   `atipicial_trie`, matching the C# `Cache` prefix);
...
use atipicial_primitives::{UINT256_SIZE, UInt256};
...
pub use atipicial_trie::MPT_NODE_PREFIX;
...
pub const MDBX_STATE_SERVICE_NAMESPACE: &str = "atipicial_state_service";
...
mod overlay_count_tests {
    ...
    use atipicial_primitives::UINT256_SIZE;
