...
//!
//! Atipicial dBFT messages travel over Atipicial's `ExtensiblePayload` wire envelope. This
...
use atipicial_payloads::{ExtensiblePayload, Witness};
use atipicial_vm::script_builder::{RedeemScript, ScriptBuilder, signature_from_invocation};
