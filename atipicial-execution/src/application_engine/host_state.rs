...
use atipicial_vm::{StackItem, VmError};
...
///
/// Native contracts sometimes need to invoke a user contract (e.g., AEP-17
/// `onAEP17Payment`) but cannot safely switch the current VM context while the
