...
const PAYLOAD_DIGEST_DOMAIN: &[u8] = b"atipicial-state-pack-migration/payload/v1\0";
const STREAM_DIGEST_DOMAIN: &[u8] = b"atipicial-state-pack-migration/stream/v1\0";
...
pub struct MigrationStreamHeader {
    /// Atipicial network magic of the source checkpoint.
