...
use super::models::{RpcAep17TokenInfo, RpcAep17Transfers};
...
/// Call AEP17 methods with RPC API
/// Matches C# `Aep17API`
pub struct Aep17Api<O = TracingRpcObserver> {
    ...
    O: RpcObserver,
{
    ...
    /// Get symbol of AEP17 token
    /// Matches C# `SymbolAsync`
    pub async fn symbol(&self, script_hash: &UInt160) -> Result<String, RpcClientError> {
        let result = self
            .contract_client
    ...
    /// Get decimals of AEP17 token
    /// Matches C# `DecimalsAsync`
    pub async fn decimals(&self, script_hash: &UInt160) -> Result<u8, RpcClientError> {
        let result = self
            .contract_client
    ...
    /// Get total supply of AEP17 token
    /// Matches C# `TotalSupplyAsync`
    pub async fn total_supply(&self, script_hash: &UInt160) -> Result<BigInt, RpcClientError> {
        let result = self
            .contract_client
    ...
    pub async fn get_token_info(
        &self,
        script_hash: &UInt160,
    ) -> Result<RpcAep17TokenInfo, RpcClientError> {
    ...
    /// Create AEP17 token transfer transaction
    ...
    /// Create AEP17 token transfer transaction with specific from address
    ...
    /// Create AEP17 token transfer transaction with optional assert emission.
    ...
    // Rationale: this helper mirrors the C# AEP-17 overload where source,
    // signer key, destination, amount, data, and assert flag are explicit.
    #[allow(clippy::too_many_arguments)]
    /// Create AEP17 token transfer transaction with explicit from and optional assert.
    ...
    #[allow(clippy::too_many_arguments)]
    /// Create AEP17 token transfer transaction from multi-sig account.
    ...
    #[allow(clippy::too_many_arguments)]
    /// Create AEP17 token transfer transaction from multi-sig account with optional assert.
    ...
    /// Get AEP17 token transfers
    /// Matches C# `GetAep17TransfersAsync`
    pub async fn get_nep17_transfers(
        &self,
        address: &str,
        start_time: Option<u64>,
        end_time: Option<u64>,
    ) -> Result<RpcAep17Transfers, RpcClientError> {
        Ok(self
            .rpc_client
    ...
    /// Get AEP17 token balances for an address
    /// Matches C# `GetAep17BalancesAsync`
    pub async fn get_nep17_balances(
        &self,
        address: &str,
    ) -> Result<Vec<RpcAep17TokenInfo>, RpcClientError> {
...
#[cfg(test)]
#[path = "../../tests/client/aep17_api.rs"]
mod tests;
