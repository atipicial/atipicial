...
use atipicial_primitives::Verifiable;
use atipicial_storage::{DataCacheReadObserver, SeekDirection, StorageItem, StorageKey};
use atipicial_vm::CandidateContract;
...
pub enum ShadowTwinBranch {
    /// Sequential AtipicialVM oracle whose output remains authoritative.
    Ordinary,
...
pub struct ShadowTwinResources<B: atipicial_storage::CacheRead> {
...
impl<B: atipicial_storage::CacheRead> ShadowTwinResources<B> {
    ...
    fn observe_range_read(
        ...
        observations.record(|journal| {
            ...
            let direction = match direction {
                SeekDirection::Forward => atipicial_vm::RangeDirection::Forward,
                SeekDirection::Backward => atipicial_vm::RangeDirection::Reverse,
            };
...
/// AtipicialVM first, and never returns candidate state as authority.
///
