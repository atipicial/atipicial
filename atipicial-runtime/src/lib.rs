...
#![doc(html_root_url = "https://docs.rs/atipicial-runtime/0.11.1")]
...
//
// Everything the spec promises at the top level of `atipicial_runtime` is
// exported here so the docstring "use atipicial_runtime::NetworkService"
...
pub use service::{
    ...
    MAX_VERIFIED_HEADER_WINDOW, Aep17Metadata, Aep17MetadataReader, NetworkEvent, NetworkService,
...
pub use service::{
    block_import, blockchain, lifecycle, aep17, outcome, services, sync_metrics, sync_pipeline,
};
