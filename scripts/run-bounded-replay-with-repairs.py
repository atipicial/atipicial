...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--reference-rpc", default="http://seed1.atipicial.com:10332")
    ...
    parser.add_argument(
        ...
        default=None,
        type=Path,
        help="Append atipicial-node stdout/stderr to this file for every replay attempt.",
    )
