...
use atipicial_state_service::{MessageType, STATE_SERVICE_CATEGORY, StateRoot, Vote};
...
fn sender_rotates_backward_with_each_retry() {
    ...
    type TestDriver = StateRootDriver<atipicial_native_contracts::StandardNativeProvider>;
...
fn driver_verifies_signed_roots_with_explicit_native_provider() {
    ...
    let verifier = include_str!("../../../../atipicial-blockchain/src/state_root/verification.rs");
