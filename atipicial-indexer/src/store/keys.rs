//! Durable key schema for the Atipicial indexer service store.

use atipicial_primitives::{UInt160, UInt256};

use crate::model::{NotificationIndexRecord, TransactionIndexRecord};

pub(crate) const LEGACY_STORE_SNAPSHOT_KEY: &[u8] = b"atipicial-indexer:snapshot:v2";
pub(crate) const STORE_SCHEMA_VERSION: &[u8] = b"3";
pub(crate) const STORE_PREFIX: &[u8] = b"atipicial-indexer:v3:";
pub(crate) const STORE_SCHEMA_VERSION_KEY: &[u8] = b"atipicial-indexer:v3:meta:schema-version";
pub(crate) const BLOCK_BY_HEIGHT_PREFIX: &[u8] = b"atipicial-indexer:v3:block-by-height:";
pub(crate) const BLOCK_BY_HASH_PREFIX: &[u8] = b"atipicial-indexer:v3:block-by-hash:";
pub(crate) const TRANSACTION_BY_CHAIN_PREFIX: &[u8] = b"atipicial-indexer:v3:tx-by-chain:";
pub(crate) const TRANSACTION_BY_HASH_PREFIX: &[u8] = b"atipicial-indexer:v3:tx-by-hash:";
pub(crate) const ACCOUNT_TRANSACTION_PREFIX: &[u8] = b"atipicial-indexer:v3:account-tx:";
pub(crate) const NOTIFICATION_BY_CHAIN_PREFIX: &[u8] = b"atipicial-indexer:v3:notification-by-chain:";
pub(crate) const NOTIFICATION_BY_BLOCK_PREFIX: &[u8] = b"atipicial-indexer:v3:notification-by-block:";
pub(crate) const NOTIFICATION_BY_TRANSACTION_PREFIX: &[u8] = b"atipicial-indexer:v3:notification-by-tx:";
pub(crate) const NOTIFICATION_BY_CONTRACT_PREFIX: &[u8] =
    b"atipicial-indexer:v3:notification-by-contract:";
pub(crate) const NOTIFICATION_BY_ACCOUNT_PREFIX: &[u8] = b"atipicial-indexer:v3:notification-by-account:";
