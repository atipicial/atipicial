...
use crate::types::json::{JsonParseError, object_array_from_iter, token_array};
...
pub fn parse_script_hash_or_address(
    ...
    address::parse_script_hash_or_address(value, protocol_settings.address_version)
}
...
where
    ...
    T::Err: Display,
{
    // String FIRST: Atipicial serializes large integers (e.g. sysfee/netfee) as
