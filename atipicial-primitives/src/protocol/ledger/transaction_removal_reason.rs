//! `TransactionRemovalReason` - matches C# Atipicial.Ledger.TransactionRemovalReason exactly.
//!
//! This is the single source of truth for transaction removal reasons. Both
//! `atipicial-core::ledger` and `atipicial-p2p` re-export this type for backward compatibility.
