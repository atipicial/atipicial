//! # atipicial-payloads::signing
//!
//! Witness, signer, and signature validation helpers.
//!
//! ## Boundary
//!
//! This module belongs to `atipicial-payloads`. This protocol crate owns payload
...
/// Extension of [`atipicial_primitives::Verifiable`] with payload-level helpers.
