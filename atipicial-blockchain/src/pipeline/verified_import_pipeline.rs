...
use atipicial_execution::{PreverifiedSignatureCache, native_contract_provider::NativeContractProvider};
use atipicial_payloads::Block;
use atipicial_storage::{CacheRead, DataCache};

use super::consensus_witness_stage::{
    ConsensusWitnessContext, AtipicialConsensusWitnessStage, SnapshotConsensusWitnessContext,
};
use super::stage_traits::{EngineResult, StageContext, ValidateStage};
use super::validate_stage::{AtipicialValidateStage, SnapshotValidateContext};
...
{
    validate: AtipicialValidateStage<SnapshotValidateContext<B>>,
    ...
    SnapshotConsensusWitnessContext<P, B>: ConsensusWitnessContext,
{
    ...
    pub fn new(
        ...
        let validate = AtipicialValidateStage::new(Arc::new(SnapshotValidateContext::new(
            Arc::clone(&chain_spec),
            Arc::clone(&snapshot),
        )));
        let consensus_witness = AtipicialConsensusWitnessStage::new(Arc::new(
    ...
    ///
    /// Validation and canonical consensus-witness AtipicialVM execution always run.
