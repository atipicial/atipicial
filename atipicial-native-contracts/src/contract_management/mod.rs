//! # atipicial-native-contracts::contract_management
//!
...
use atipicial_execution::{
    ApplicationEngine, ContractState, NativeContract, NativeEvent, NativeMethod,
};
    ...
    P: atipicial_execution::native_contract_provider::NativeContractProvider + 'static,
{
    ...
    /// native or user — resolves its AEF/manifest through here. Delegates to
