//! Reference counting for the Atipicial VM — the C# v3.10.1 recursive
//! stack-reference model (`Atipicial.VM.ReferenceCounter`, atipicial-vm v3.10.1).
//!
...
/// Tracks references to VM stack items (C# `Atipicial.VM.ReferenceCounter`).
#[derive(Clone, Debug)]
...
atipicial_io::impl_default_via_new!(ReferenceCounter);

#[cfg(test)]
#[path = "../tests/runtime/reference_counter.rs"]
mod tests;
