...
//! # atipicial-rpc
//!
//! Atipicial JSON-RPC client, server, models, plugins, and transport adapters.
//!
//! ## Boundary
//!
...
//! - `protocol`: Shared Atipicial JSON-RPC protocol codecs.
...
/// Plugin implementations (merged from `atipicial-tokens-tracker`).
#[cfg(feature = "server")]
pub mod plugins;
...
#[cfg(feature = "client")]
pub use client::{
    ClientRpcError, ContractClient, Aep17Api, PolicyApi, RpcClient, RpcClientBuilder,
