...
use atipicial_primitives::{CallFlags, ContractParameterType, UInt160, UInt256};
...
/// standards before HF_Faun, AEP-30 from the Faun height — and the Faun
...
fn manifest_standards_gain_nep30_at_faun() {
    ...
    assert_eq!(after.manifest.supported_standards, ["AEP-30"]);
