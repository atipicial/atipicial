...
impl VmState {
    /// C# Atipicial.VM-compatible state constant.
    ...
    /// Returns the C# Atipicial.VM byte tag for this state.
    #[must_use]
    pub const fn to_byte(self) -> u8 {
        self as u8
    }

    /// Decodes a persisted C# Atipicial.VM state byte.
    #[must_use]
