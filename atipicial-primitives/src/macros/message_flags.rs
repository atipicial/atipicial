/// Generates the Atipicial P2P message flag wrapper while preserving unknown bits.
///
/// Atipicial treats message flags as a raw byte with bit flags. Only bit `0x01`
...
/// Atipicial byte-oriented API used by the network serializers.
#[macro_export]
