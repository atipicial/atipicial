...
/// Narrow context required by [`super::AtipicialConsensusWitnessStage`].
pub trait ConsensusWitnessContext:
    ChainSpecProvider<ChainSpec = AtipicialChainSpec> + Send + Sync + fmt::Debug + 'static
{
    ...
    /// Returns the explicit native provider used by AtipicialVM host calls.
