...
use atipicial_payloads::{Block, ExtensiblePayload};
use atipicial_runtime::{CheckedBlockBatch, ServiceError};
...
impl BlockchainHandle {
    ...
    /// proves only [`atipicial_runtime::BlockImport::check`] completed successfully.
