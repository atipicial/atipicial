//! Comprehensive MPT tests converted from C# Atipicial.Cryptography.MPTTrie.Tests
//! Covers all test cases from UT_Node.cs, UT_Trie.cs, and UT_Cache.cs

use crate::mpt::node::MAX_KEY_LENGTH;
use crate::{MptCache, MptMutationStats, MptResult, MptStoreSnapshot, Node, NodeType, Trie};
...
trait SerializableExt: Serializable {
    fn to_array(&self) -> atipicial_io::IoResult<Vec<u8>> {
