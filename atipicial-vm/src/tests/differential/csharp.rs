...
const ATC_VM_COMMIT: &str = "004cd6070a940405818d9357638277dd44407e2e";

fn fixture() -> Value {
    serde_json::from_str(FIXTURE).expect("valid C# Atipicial.VM fixture")
}
...
fn csharp_v3101_fixture_has_pinned_complete_coverage() {
    ...
    assert_eq!(fixture["oracle"]["commit"], ATC_VM_COMMIT);
