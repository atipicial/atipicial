//! # AtipicialVM execution plans
//!
//! Immutable, versioned execution plans for AtipicialVM bytecode.
//!
//! ## Boundary
//!
//! Plans accelerate decoding and dispatch while preserving ordinary AtipicialVM
//! stack items, gas, faults, diagnostics, and host interactions. This module
//! neither executes contracts outside AtipicialVM nor caches stateful results.
//!
//! ## Contents
//!
