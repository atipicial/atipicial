//! # atipicial-serialization::tests::compression
//!
//! Test module grouping Compression codecs and deterministic envelope helpers.
//! coverage for atipicial-serialization.
//!
//! ## Boundary
//!
//! This is test/benchmark-only code for atipicial-serialization; it may assemble
...
fn compress_lz4_roundtrip() {
    let data = b"Hello, Atipicial blockchain! This is test data for lz4 compression.".to_vec();
...
fn compress_zstd_roundtrip() {
    let data = b"Hello, Atipicial blockchain! This is test data for zstd.".to_vec();
