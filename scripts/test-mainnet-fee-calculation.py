#!/usr/bin/env python3
"""
Compare transaction fee calculation between atipicial-rs and C# using mainnet data.
...
def main():
    ...
    csharp_rpc = "http://seed1.atipicial.com:10332"  # Public C# mainnet node
    
    print("Comparing fee calculation: atipicial-rs vs C#\n")
