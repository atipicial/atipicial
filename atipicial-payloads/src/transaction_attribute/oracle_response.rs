...
use atipicial_primitives::OracleResponseCode;
...
impl OracleResponse {
    ...
    pub fn get_fixed_script() -> Vec<u8> {
        ...
        builder.emit_syscall_hash(atipicial_vm::interop_hash("System.Contract.Call"));
        builder.to_array()
    }

    // verify: Mirrors C# `OracleResponse.Verify`
    // (Atipicial/Network/P2P/Payloads/OracleResponse.cs), all five checks.
