...
mod tests {
    ...
    fn classifier_exposes_the_concrete_io_error() {
        ...
        let error = PackStoreError::classify_create(source, Path::new("/var/lib/atipicial/packs"));
    ...
    fn classifier_does_not_report_worker_pool_failure_as_corruption() {
        ...
        let error = PackStoreError::classify_open(source, Path::new("/var/lib/atipicial/packs"));
