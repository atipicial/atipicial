...
//! WitnessRule - Conditional witness validation for Atipicial N3.
//!
//! This module provides witness rule evaluation for conditional transaction
//! verification, matching the C# Atipicial implementation exactly.
//!
//! ## Overview
//!
...
// Stack projection lives in atipicial-core (depends on the VM crate) so atipicial-io stays
// free of any VM dependency.
#[path = "../witness_rule/stack_projection.rs"]
mod stack_projection;

pub use atipicial_primitives::WitnessConditionType;
pub use atipicial_primitives::WitnessRuleAction;
...
pub enum WitnessCondition {
    ...
    ScriptHash {
        ...
        hash: atipicial_primitives::UInt160,
    },
