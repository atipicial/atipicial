...
use atipicial_execution::native_contract_provider::{
    NativeContractProvider, NoNativeContractProvider,
};
use atipicial_execution::{ApplicationEngine, Diagnostic, NativeMethod, NoDiagnostic};
use atipicial_storage::{CacheRead, EmptyCacheBacking};
...
///
/// Use this for contracts such as StdLib where the Atipicial ABI exposes multiple
