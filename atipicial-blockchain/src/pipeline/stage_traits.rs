...
//!
//! These traits were previously in the `atipicial-engine` crate (ADR-009/010/026).
//! The `atipicial-engine` crate was deleted in ADR-027 because its entire public
...
pub enum EngineError {
    ...
    Service(#[from] atipicial_runtime::ServiceError),
