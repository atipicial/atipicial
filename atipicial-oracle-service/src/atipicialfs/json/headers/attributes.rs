...
pub(super) fn build_atipicialfs_attribute_list(
    ...
    build_atipicialfs_attribute_headers(headers)
}

fn build_atipicialfs_attribute_headers(
    headers: &reqwest::header::HeaderMap,
) -> Option<Vec<(String, String)>> {
...
pub(super) fn build_atipicialfs_attribute_json(attributes: &[(String, String)]) -> String {
