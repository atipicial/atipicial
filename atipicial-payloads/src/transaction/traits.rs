...
use atipicial_primitives::SerializablePayload;
...
impl Transaction {
    /// Converts the transaction to a atipicial-vm stack item (matches C# `Transaction.ToStackItem` layout).
...
atipicial_io::impl_default_via_new!(Transaction);
