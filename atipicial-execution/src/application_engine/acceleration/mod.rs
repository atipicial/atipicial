//! # atipicial-execution::application_engine::acceleration
//!
...
//! execution, but AtipicialVM remains the semantic authority. It must not cache
//! execution results, publish candidate state, or bypass full artifact parity.
//!
//! ## Contents
//!
//! - `execution_plans`: bounded immutable AtipicialVM plan reuse.
