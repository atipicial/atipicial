...
/// C# `AtipicialSystem.CreateGenesisBlock` timestamp:
/// **2026-07-20 00:00:00 UTC** — the Atipicial Chain genesis date.
pub const GENESIS_TIMESTAMP_MS: u64 = 1_784_505_600_000;

/// C# `AtipicialSystem.CreateGenesisBlock` nonce.
...
pub struct GenesisConfig {
    ...
    /// Genesis block nonce (the Bitcoin genesis nonce used by Atipicial N3).
...
pub struct TokenDistribution {
    /// Token type (ATC or GAS)
    pub token: TokenType,

    /// Recipient address (Atipicial address format)
    pub address: String,
...
impl GenesisConfig {
    ...
    pub fn mainnet() -> Self {
        Self {
            // Atipicial N3 genesis timestamp: 2026-07-20T00:00:00Z.
                ...
                GenesisValidator {
                    public_key:
                        "03b209fd4f53a7170ea4444e0cb0a6bb6a53c2bd016926989cf85f9b0fba17a70c"
                            .to_string(),
                    name: Some("Atipicial Foundation 1".to_string()),
                },
                GenesisValidator {
                    public_key:
                        "02df48f60e8f3e01c48ff40b9b7f1310d7a8b2a193188befe1c2e3df740e895093"
                            .to_string(),
                    name: Some("Atipicial Foundation 2".to_string()),
                },
                GenesisValidator {
                    public_key:
                        "03b8d9d5771d8f513aa0869b9cc8d50986403b78c6da36890638c3d46a5adce04a"
                            .to_string(),
                    name: Some("Atipicial Foundation 3".to_string()),
                },
                GenesisValidator {
                    public_key:
                        "02ca0e27697b9c248f6f16e085fd0061e26f44da85b58ee835c110caa5ec3ba554"
                            .to_string(),
                    name: Some("Atipicial Foundation 4".to_string()),
                },
                GenesisValidator {
                    public_key:
                        "024c7b7fb6c310fccf1ba33b082519d82964ea93868d676662d4a59ad548df0e7d"
                            .to_string(),
                    name: Some("Atipicial Foundation 5".to_string()),
                },
                GenesisValidator {
                    public_key:
                        "02aaec38470f6aad0042c6e877cfd8087d2676b0f516fddd362801b9bd3936399e"
                            .to_string(),
                    name: Some("Atipicial Foundation 6".to_string()),
                },
                GenesisValidator {
                    public_key:
                        "02486fd15702c4490a26703112a5cc1d0923fd697a33406bd5a1c00e0013b09a70"
                            .to_string(),
                    name: Some("Atipicial Foundation 7".to_string()),
                },
            ],
            committee: vec![
