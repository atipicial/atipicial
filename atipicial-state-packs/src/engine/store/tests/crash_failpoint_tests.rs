    const CRASH_ROOT_ENV: &str = "ATC_STATE_PACKS_CRASH_TEST_ROOT";
    const APPEND_CRASH_ROOT_ENV: &str = "ATC_STATE_PACKS_APPEND_CRASH_TEST_ROOT";
    const RECOVERY_REBUILD_CRASH_ROOT_ENV: &str = "ATC_STATE_PACKS_RECOVERY_REBUILD_CRASH_TEST_ROOT";
    const RECOVERY_REBUILD_EXTERNAL_CRASH_ROOT_ENV: &str =
        "ATC_STATE_PACKS_RECOVERY_REBUILD_EXTERNAL_CRASH_TEST_ROOT";
    const RECOVERY_REBUILD_HORIZON_EPOCH_ENV: &str =
        "ATC_STATE_PACKS_RECOVERY_REBUILD_HORIZON_EPOCH";
    const RECOVERY_REBUILD_HORIZON_SEGMENT_ENV: &str =
        "ATC_STATE_PACKS_RECOVERY_REBUILD_HORIZON_SEGMENT";
    const RECOVERY_REBUILD_HORIZON_END_ENV: &str =
        "ATC_STATE_PACKS_RECOVERY_REBUILD_HORIZON_END";
    const RECOVERY_REBUILD_HORIZON_BLOCK_START_ENV: &str =
        "ATC_STATE_PACKS_RECOVERY_REBUILD_HORIZON_BLOCK_START";
    const RECOVERY_REBUILD_HORIZON_BLOCK_END_ENV: &str =
        "ATC_STATE_PACKS_RECOVERY_REBUILD_HORIZON_BLOCK_END";
    const RECOVERY_REBUILD_HORIZON_PREVIOUS_ROOT_ENV: &str =
        "ATC_STATE_PACKS_RECOVERY_REBUILD_HORIZON_PREVIOUS_ROOT";
    const RECOVERY_REBUILD_HORIZON_RESULTING_ROOT_ENV: &str =
        "ATC_STATE_PACKS_RECOVERY_REBUILD_HORIZON_RESULTING_ROOT";
    const RECOVERY_REBUILD_HORIZON_FRAME_DIGEST_ENV: &str =
        "ATC_STATE_PACKS_RECOVERY_REBUILD_HORIZON_FRAME_DIGEST";
