//! # atipicial-native-contracts::tests::ledger_contract
//!
//! Test module grouping Native Ledger contract storage and query behavior.
//! coverage for atipicial-native-contracts.
//!
//! ## Boundary
//!
...
use atipicial_vm::{ExecutionEngineLimits, Interoperable, StackItem, VmState as VMState};
...
fn get_trimmed_block_round_trips_through_storage() {
    use atipicial_payloads::{Header, TrimmedBlock};
...
/// zero encoded as the empty span — Atipicial.VM `Integer`).
#[test]
