//! Atipicial-compatible Bloom filter adapter.
//!
//! Bit storage is delegated to `bitvec` and hashing is delegated through the
//! crate-local Murmur3 adapter. This module owns the Atipicial-specific contract:
...
#[cfg(test)]
#[path = "../tests/filters/bloom_filter.rs"]
mod tests;
