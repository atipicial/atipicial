//! # atipicial-storage::persistence
//!
//! Persistence traits, snapshots, transactions, and cache overlays.
//!
//! ## Boundary
//!
//! This module belongs to `atipicial-storage`. This infrastructure crate owns store
...
/// Data cache with Atipicial-style trackable entries.
pub mod data_cache;
