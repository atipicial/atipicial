//! # atipicial-indexer::tests::service
//!
...
//! ## Boundary
//!
//! This is test/benchmark-only code for atipicial-indexer; it may assemble fixtures
...
use atipicial_storage::persistence::providers::memory_store_provider::MemoryStoreProvider;
use atipicial_storage::persistence::{ReadOnlyStoreGeneric, SeekDirection, StoreSnapshot, WriteStore};
