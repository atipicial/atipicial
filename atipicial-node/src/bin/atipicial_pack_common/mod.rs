//! # atipicial-node::atipicial_pack_common
//!
//! Shared composition helpers for offline authoritative state-pack tools.
//!
//! ## Boundary
//!
//! This module adapts a pinned `atipicial-state-packs` snapshot to the canonical MPT
//! read capability. Pack formats remain opaque to `atipicial-crypto`, while pack
...
use atipicial_state_packs::{PACK_KEY_BYTES, PackStore, Snapshot};
use atipicial_trie::{
