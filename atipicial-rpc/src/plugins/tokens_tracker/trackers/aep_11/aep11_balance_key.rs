//! AEP-11 balance key.
//!
//! Storage key for AEP-11 (NFT) balances.
...
/// Storage key for AEP-11 balances: `[UserScriptHash, AssetScriptHash, TokenId]`.
#[derive(Debug, Clone, PartialEq, Eq, Hash, Serialize, Deserialize, Default)]
pub struct Aep11BalanceKey {
    /// User's script hash.
...
impl PartialOrd for Aep11BalanceKey {
    fn partial_cmp(&self, other: &Self) -> Option<Ordering> {
        Some(self.cmp(other))
    }
}

impl Ord for Aep11BalanceKey {
