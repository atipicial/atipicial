...
fn native_contract_handle_names_are_uniform_constants() {
    ...
    let contracts = [
        ...
        handle_case!(AtipicialCoin),
        handle_case!(AtipicialDollar),
...
mod native_handle_api {
    ...
    fn native_contract_handle_hash_accessors_are_uniform() {
        ...
        assert_eq!(AtipicialCoin::new().hash(), AtipicialCoin::script_hash());
        assert_eq!(
            AtipicialDollar::new().hash(),
    ...
    fn native_contract_hashes_match_csharp_v3_10_fixture() {
        let expected = [
            ...
            (
                ...
                "0x12f8270fcfd2bd81ad91fa3a627352a7aeae4097",
            ),
            (
                AtipicialDollar::NAME,
                AtipicialDollar::script_hash(),
                "0x487c160234e45c0158572d22dd3a04ec0e0bc14c",
            ),
            (
                PolicyContract::NAME,
