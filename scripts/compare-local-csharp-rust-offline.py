...
def compare(rust_url: str, csharp_url: str):
    checks = [
        ...
        (
            "invokefunction(AtipicialCoin.getCandidates)",
            lambda url: rpc_call(
                url,
                "invokefunction",
        ...
        (
            "invokefunction(AtipicialCoin.getAllCandidates)",
            lambda url: rpc_call(
                url,
                "invokefunction",
                [
        ...
        (
            "invokefunction(AtipicialCoin.totalSupply)",
            lambda url: rpc_call(
                url,
                "invokefunction",
        ...
        (
            "invokefunction(AtipicialCoin.readonly)",
            lambda url: {
                method: rpc_call(
                    url,
                    "invokefunction",
        ...
        (
            "invokefunction(AtipicialDollar.readonly)",
            lambda url: {
                method: rpc_call(
                    url,
                    "invokefunction",
...
def main():
    parser = argparse.ArgumentParser(
        description="Compare offline Rust and C# Atipicial RPC nodes on genesis-safe methods."
    )
