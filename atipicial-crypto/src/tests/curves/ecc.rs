...
fn test_verify_secp256r1_signature() {
    ...
    let pub_bytes = signing_key
        ...
        .as_bytes()
        .to_vec();
    let message = b"atipicial-secp256r1";
...
fn verify_with_hash_sha256_matches_default_verify() {
    ...
    let pub_bytes = signing_key
        ...
        .as_bytes()
        .to_vec();
    let message = b"atipicial-ecdsa-hash-selectable";
    let signature: P256Signature = signing_key.sign(message);
...
fn verify_with_hash_keccak256_round_trips_both_curves() {
    ...
    let message = b"atipicial-keccak-ecdsa";
...
fn test_verify_secp256k1_signature() {
    ...
    let pub_bytes = signing_key
        ...
        .as_bytes()
        .to_vec();
    let message = b"atipicial-secp256k1";
...
fn test_verify_ed25519_signature() {
    ...
    let message = b"atipicial-ed25519";
...
/// verification path Atipicial uses (`Ed25519Signer.Init(false, Ed25519PublicKeyParameters)`
...
fn verify_ed25519_matches_bouncycastle_accept_set() {
    ...
    let cases: &[(&str, &str, &str, &[u8], bool)] = &[
        // Valid signature over "atipicial" with a real key: both C# and atipicial-rs accept.
        (
            "valid_baseline",
