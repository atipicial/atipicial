//! JSON-RPC error codes matching Atipicial RPC server implementation.
...
macro_rules! rpc_error_codes {
    (
        ...
        /// Standard JSON-RPC 2.0 error codes and Atipicial-specific error codes.
...
rpc_error_codes! {
    ...
    // Atipicial: unknown entities (-101..-109), matching C# Atipicial.Plugins.RpcServer.RpcError
    ...
    // Atipicial: inventory/verification (-500..-512)
    ...
    // Atipicial: server / session / oracle / state (-600..-608)
    /// Access denied.
