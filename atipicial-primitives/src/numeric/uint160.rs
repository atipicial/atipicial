...
impl UInt160 {
    ...
    /// Converts this `UInt160` to a Atipicial address string.
    #[must_use]
    ...
    /// Converts this `UInt160` to a Atipicial address string using an explicit
    ...
    /// Parses a Atipicial address string to a `UInt160`.
    ///
    /// # Errors
    ///
    ...
    #[must_use]
    /// Returns the Atipicial-compatible 32-bit hash code for this value.
    // Rationale: Atipicial's C# hash-code algorithm intentionally folds unsigned
