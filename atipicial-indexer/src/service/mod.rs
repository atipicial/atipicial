//! # atipicial-indexer::service
//!
//! Thread-safe projection commands, queries, and service-store durability.
//!
//! ## Boundary
//!
//! This module belongs to `atipicial-indexer`. This service crate owns projections
...
use atipicial_storage::persistence::{Store, providers::RuntimeStore};
