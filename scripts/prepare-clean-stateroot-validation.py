...
DEFAULT_BASE_CONFIG = "atipicial_mainnet_validate.toml"
DEFAULT_WORK_ROOT = "data/mainnet-stateroot-clean"
DEFAULT_NODE_BIN = "target/debug/atipicial-node"
...
def build_plan(
    *,
    ...
    config_path = work_root / "atipicial_mainnet_validate.toml"
    ...
    return {
        ...
        "commands": {
            ...
            "bounded-smoke": [
                ...
                "--node-output-log",
                str(log_dir / "atipicial-node-bounded-smoke.log"),
            ],
            "checkpoint-smoke": [
