//! Script - Atipicial VM bytecode representation.
//!
//! This module provides the `Script` type for representing and parsing
//! Atipicial Virtual Machine bytecode.
//!
//! ## Overview
//!
...
//!
//! ```rust,ignore
//! use atipicial_core::atipicial_vm::Script;
//! use crate::OpCode;
//!
...
/// Represents a script in the Atipicial VM.
///
/// # Performance
///
