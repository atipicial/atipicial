...
//! # atipicial-execution
//!
//! Atipicial application execution, interop host logic, contract state, and storage
//! helpers.
//!
//! ## Boundary
//!
...
//!   witnesses while retaining complete AtipicialVM verification.
...
pub mod contracts;
/// AtipicialVM syscall handlers registered into the application engine.
pub mod interop;
...
pub use native::aep17_reader::Aep17MetadataReaderImpl;
