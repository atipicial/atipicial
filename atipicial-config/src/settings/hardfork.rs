...
//! Deterministic Atipicial N3 hardfork schedules.
//!
//! Atipicial v3.10.1 defines exactly eight height-activated hardforks. A fixed table
...
pub use atipicial_primitives::{Hardfork, HardforkParseError};

/// A compact set of configured or active Atipicial hardforks.
...
/// Validation failure for a Atipicial hardfork schedule.
...
/// Fixed, declaration-ordered activation heights for Atipicial N3 hardforks.
///
...
impl HardforkSchedule {
    ...
    /// Returns the Atipicial N3 v3.10.1 MainNet schedule.
    #[must_use]
    ...
    /// Returns the Atipicial N3 v3.10.1 TestNet schedule.
    #[must_use]
    ...
    /// Applies Atipicial's C# omitted-leading-hardfork rule.
    ///
